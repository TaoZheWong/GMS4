...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class UserAccessDocument : PersistBase<UserAccessDocument>, IObjectHelper
	{
		#region Properties
		...
		public UserAccessDocument() : base()
		{
			// Default Constructor
		}
        ...
        public static UserAccessDocument RetrieveByKey(short userNumID, short documentID)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("UserAccessDocument.UserNumID", userNumID);
			where += " and ";
			where += helper.GetExpression("UserAccessDocument.DocumentID", documentID);
