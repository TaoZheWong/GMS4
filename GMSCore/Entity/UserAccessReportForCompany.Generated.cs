...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class UserAccessReportForCompany : PersistBase<UserAccessReportForCompany>, IObjectHelper
	{
		#region Properties
		...
		public UserAccessReportForCompany() : base()
		{
			// Default Constructor
		}
        ...
        public static UserAccessReportForCompany RetrieveByKey(short coyID, short userNumID, short reportID)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("UserAccessReportForCompany.CoyID", coyID);
			where += " and ";
			where += helper.GetExpression("UserAccessReportForCompany.UserNumID", userNumID);
			where += " and ";
			where += helper.GetExpression("UserAccessReportForCompany.ReportID", reportID);
