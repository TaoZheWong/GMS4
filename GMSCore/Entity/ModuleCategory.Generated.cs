...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class ModuleCategory : PersistBase<ModuleCategory>, IObjectHelper
	{
		#region Properties
		...
		///<summary>Collection of Module objects</summary>
		public IList<Module> ModuleList
		{
        ...
        public static ModuleCategory RetrieveByKey(short moduleCategoryID)
		{
			DBManager db = DBManager.GetInstance();
			return db.Engine.GetObject<ModuleCategory>(moduleCategoryID);
		}
		...
		{			
			...
			string where = helper.GetExpression("ModuleCategory.ModuleCategoryID", moduleCategoryID);
		...
		object IObjectHelper.this[string memberName]
		{
			get {
				switch (memberName) {
					...
					case "_ModuleList": return _ModuleList;
			...
			set {
				...
				switch (memberName) {
					...
					case "_ModuleList": _ModuleList = (IList<Module>)value; break;
