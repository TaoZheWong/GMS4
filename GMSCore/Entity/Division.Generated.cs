...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class Division : PersistBase<Division>, IObjectHelper
	{
		#region Properties
		...
		public Division(bool startTracking) : base(startTracking)
		{
        ...
        public static Division RetrieveByKey(short divisionID)
		{
			DBManager db = DBManager.GetInstance();
			return db.Engine.GetObject<Division>(divisionID);
		}
		...
		{			
			...
			string where = helper.GetExpression("Division.DivisionID", divisionID);
