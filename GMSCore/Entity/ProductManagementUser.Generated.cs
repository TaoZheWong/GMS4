...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class ProductManagementUser : PersistBase<ProductManagementUser>, IObjectHelper
	{
		#region Properties
        ...
        public ProductManagementUser() : base()
		{
			// Default Constructor
		}
        ...
        public static ProductManagementUser RetrieveByKey(short coyID, short mGUserID)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("ProductManagementUser.CoyID", coyID);
			where += " and ";
			where += helper.GetExpression("ProductManagementUser.MGUserID", mGUserID);
