...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class AccountTerritory : PersistBase<AccountTerritory>, IObjectHelper
	{
		#region Properties
        ...
        public static AccountTerritory RetrieveByKey(string code)
		{
			DBManager db = DBManager.GetInstance();
			return db.Engine.GetObject<AccountTerritory>(code);
		}
		...
		{			
			...
			string where = helper.GetExpression("AccountTerritory.Code", code);
