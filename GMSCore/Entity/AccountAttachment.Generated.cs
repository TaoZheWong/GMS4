...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class AccountAttachment : PersistBase<AccountAttachment>, IObjectHelper
	{
		#region Properties
		...
		public AccountAttachment() : base()
		{
			// Default Constructor
		}
		///<summary>Initializes a new instance of this class</summary>
		///<param name="startTracking">Set to true to begin ORMapper tracking on this instance</param>
		public AccountAttachment(bool startTracking) : base(startTracking)
		{
        ...
        public static AccountAttachment RetrieveByKey(short id)
		{
			DBManager db = DBManager.GetInstance();
			return db.Engine.GetObject<AccountAttachment>(id);
		}
		...
		{			
			...
			string where = helper.GetExpression("AccountAttachment.Id", id);
