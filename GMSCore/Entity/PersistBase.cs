...
namespace GMSCore.Entity
{
        ...
        where T : IPersist
    {
        ...
        public PersistBase(bool startTracking)
            : base()
        {
            if (startTracking)
            {
        ...
        public virtual void Save(bool includeChildren)
        {
            ...
            db.Engine.PersistChanges(this, depth);
        ...
        public static int Delete(T instance)
        {
            ...
            DBManager db = DBManager.GetInstance();
            if (db.Engine.GetObjectState(instance) == ObjectState.Unknown)
                db.Engine.StartTracking(instance, InitialState.Updated);
        ...
        {
            DBManager db = DBManager.GetInstance();
            return db.Engine.ExecuteDelete(typeof(T), whereClause);
        }
        ...
        {
            DBManager db = DBManager.GetInstance();
            return db.Engine.ExecuteUpdate(typeof(T), whereClause, updateClause);
        }
