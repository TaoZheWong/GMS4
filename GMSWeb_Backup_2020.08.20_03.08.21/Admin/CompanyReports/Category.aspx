<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="GMSWeb.Reports.Setup.Category" %>
...
<head runat="server">
    <title>Company Reports - Category</title>
</head>
<body>
    <form id="form1" runat="server">
    <div id="ContentBar">
        <h3>Company Reports &gt; Category</h3>
