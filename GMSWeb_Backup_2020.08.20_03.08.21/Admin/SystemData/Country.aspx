<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Country.aspx.cs" Inherits="GMSWeb.Admin.SystemData.Country" %>
...
<head id="Head1" runat="server">
    <title>System - Country</title>
</head>
<body>
    <form id="form1" runat="server">
    <div id="ContentBar">
        <h3>System &gt; Country</h3>
        ...
        <table class="tTable" style="width: 100%">
            <tr>
			    <td>
				    <br /> 
				    <div class="tTable">
					    <atlas:UpdatePanel ID="udpCountryUpdater" runat="server" Mode="conditional">
						    <ContentTemplate>
							    <asp:DataGrid ID="dgCountry" runat="server" AutoGenerateColumns="false" ShowFooter="true"
								    DataKeyField="CountryId" OnCancelCommand="dgCountry_CancelCommand" OnEditCommand="dgCountry_EditCommand"
								    OnUpdateCommand="dgCountry_UpdateCommand" OnItemCommand="dgCountry_CreateCommand"
								    GridLines="none" OnItemDataBound="dgCountry_ItemDataBound" OnDeleteCommand="dgCountry_DeleteCommand"
								    ...
								    <Columns>
									    ...
									    <asp:TemplateColumn HeaderText="Country" ItemStyle-Width="80px">
										    <ItemTemplate>
