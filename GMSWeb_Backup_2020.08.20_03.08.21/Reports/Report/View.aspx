<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="GMSWeb.Reports.Report.View" %>
...
<body ID="theBody" runat="server">
	...
	<div id="GroupContentBar">
		<h3>Report &gt; View</h3>
		Expand a category and click a report for the category to view.
		<br /><br />    
		<table class="tGroupTable" style="width: 99%;">
			<tr valign="top">
				<td style="width: 70%;">
				<asp:Repeater id="rppCategoryList" Runat="server">
					...
					<ItemTemplate>
						...
						<tr id="rppToggle_<%# Container.ItemIndex %>" style="display:none">
							<td>
