<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="GMSWeb.HR.Resources.Category" %>
...
<head id="Head1" runat="server">
    <title>Resources - Category</title>
</head>
<body>
    <form id="form1" runat="server">
    <div id="ContentBar">
        <h3>Resources &gt; Category</h3>
        Add new category to the Resources or click on a category to modify.
        <br />
						    ...
						    <ContentTemplate>
							    <asp:DataGrid ID="dgCategory" runat="server" AutoGenerateColumns="false" ShowFooter="true"
								    ...
								    <Columns>
									    ...
									    <asp:TemplateColumn HeaderText="Category" ItemStyle-Width="180px">
										    <ItemTemplate>
