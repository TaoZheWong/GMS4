<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorEvaluationForm9.aspx.cs" Inherits="GMSWeb.Procurement.Forms.VendorEvaluationForm9" %>
                ...
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                       ...
                       <div class="form-horizontal m-t-20">
                         ...
                         <div class="form-group col-lg-12">       
                                <asp:TextBox TextMode="multiline" ID="txtVendorComment6" runat="server" Rows="5" Columns="100" MaxLength="100" CssClass="form-control" />    
                ...
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                        ...
                        <div class="form-group col-lg-12">       
                         ...
                         <label class="col-sm-12 control-label text-left"> Comments by Vendor </label>                      
                         <div class="form-group col-lg-12">       
                                <asp:TextBox TextMode="multiline" ID="txtVendorComment7" runat="server" Rows="5" Columns="100" MaxLength="100" CssClass="form-control" />       
                ...
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                        ...
                        <div class="form-group col-lg-12">       
                         ...
                         <label class="col-sm-12 control-label text-left"> Comments by Vendor </label>                      
                         <div class="form-group col-lg-12">       
                                <asp:TextBox TextMode="multiline" ID="txtVendorComment8" runat="server" Rows="5" Columns="100" MaxLength="100" CssClass="form-control" />       
