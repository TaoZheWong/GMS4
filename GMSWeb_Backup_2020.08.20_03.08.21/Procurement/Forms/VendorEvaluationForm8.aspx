<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorEvaluationForm8.aspx.cs" Inherits="GMSWeb.Procurement.Forms.VendorEvaluationForm8" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
                ...
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                       ...
                       <div class="form-horizontal m-t-20">
                         ...
                         <div class="form-group col-lg-12">       
                                <asp:TextBox TextMode="multiline" ID="txtVendorComment3" runat="server" Rows="5" Columns="100" MaxLength="100" CssClass="form-control" />    
                ...
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                        ...
                        <div class="form-group col-lg-12">       
                         ...
                         <label class="col-sm-12 control-label text-left"> Comments by Vendor </label>                      
                         <div class="form-group col-lg-12">       
                                <asp:TextBox TextMode="multiline" ID="txtVendorComment4" runat="server" Rows="5" Columns="100" MaxLength="100" CssClass="form-control" />       
            ...
            <div class="panel panel-primary">                
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                        ...
                        <div class="form-group col-lg-12">       
                         ...
                         <label class="col-sm-12 control-label text-left"> Comments by Vendor </label>                      
                         <div class="form-group col-lg-12">       
                                <asp:TextBox TextMode="multiline" ID="txtVendorComment5" runat="server" Rows="5" Columns="100" MaxLength="100" CssClass="form-control" />       
                ...
                <div class="form-horizontal m-t-20">  
                    ...
                    <div class="form-group col-lg-6 col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <asp:TextBox CssClass="form-control" ID="txtDocumentName3" runat="server" />
                        </div>
                    </div>
                    <div class="form-group col-lg-6 col-sm-6">
                        <label class="col-sm-6 control-label text-left">
            ...
            <div class="panel-footer clearfix">
                ...
                <asp:Label ID="lblMsg3" runat="server" ForeColor="red"></asp:Label></small>
                <asp:Button ID="btnUpload3" runat="server" CausesValidation="true" Text="Upload or Update" CssClass="btn btn-warning pull-right"
                    OnClick="btnUpload3_Click" OnClientClick="this.disabled=true; this.value='Updating ...';" UseSubmitBehavior="false" />
            </div>
                </div>
            </div>
