<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorRecords7.aspx.cs" Inherits="GMSWeb.Procurement.Records.VendorRecords7" %>
                ...
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                        ...
                        <div class="form-horizontal m-t-20">
                         ...
                         <div class="form-group col-lg-12">       
                                <asp:TextBox TextMode="multiline" ID="txtVendorComment1" runat="server" Rows="5" Columns="100" MaxLength="100" CssClass="form-control" readonly/>    
                ...
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                        ...
                        <div class="form-group col-lg-12">       
                         ...
                         <label class="col-sm-12 control-label text-left"> Comments by Vendor </label>                      
                         <div class="form-group col-lg-12">       
                                <asp:TextBox TextMode="multiline" ID="txtVendorComment2" runat="server" Rows="5" Columns="100" MaxLength="100" CssClass="form-control" readonly/>      
