<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorRecords.aspx.cs" Inherits="GMSWeb.Procurement.Records.VendorRecords" %>
...
<head id="Header1" runat="server">
    ...
    <title>Vendor Evaluation Form</title>
    ...
    <form id="form2" runat="server">
        <div class="container">
               <ul class="breadcrumb pull-right">
                ...
                <li class="active">Approve/Reject Vendor Evaluation Form</li>
             </ul>
             <h1 class="page-header">Vendor Evaluation Form <br />
                <small>Approve or Reject a Vendor Evaluation Form.</small></h1>
            <div class="clearfix"></div> 
             <asp:ScriptManager ID="sriptmgr2" runat="server">
            </asp:ScriptManager>
                         ...
                         <div class="form-group col-lg-12">
                            ...
                            <div class="col-sm-8">
                                <label class="control-label ">
                                    ...
                                    <input type="hidden" id="hidVendorID3" runat="server" />
                                    <input type="hidden" id="hidFormID3" runat="server" />
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtTypeOfOwnership1" runat="server" Columns="100" MaxLength="100" CssClass="form-control"/>
                            <input type="hidden" id="hidFormID4" runat="server" />
                            <input type="hidden" id="hidTypeOfOwnership1" runat="server" />
                        </div>
                    </div>
                          ...
                          <div class="form-group col-lg-12">
                            ...
                            <div class="col-sm-8">
                                <asp:TextBox ID="txtNatureOfBusiness1" runat="server" Columns="100" MaxLength="100"
                 ...
                 <div class="panel-footer clearfix">          
                      <asp:Button ID="btnRejected" Text="Reject" EnableViewState="False" runat="server" CssClass="btn btn-warning pull-right m-r-10"
                         OnClick="btnRejected_Click"></asp:Button>
                     <asp:Button ID="btnApproved" Text="Approve" EnableViewState="False" runat="server" CssClass="btn btn-success pull-right m-r-10"
                       ValidationGroup="valGrpNewRow" OnClick="btnApproved_Click"></asp:Button>
                 </div>
                <div class="panel-footer">
        <asp:HyperLink ID="lnkVendorEvaluation1" Visible="False" runat="server" CssClass="text-info"></asp:HyperLink>
    </div> 
            </div>
