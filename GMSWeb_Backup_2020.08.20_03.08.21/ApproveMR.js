...
$(document).ready(function() { 
       ...
       $('#FormSearch input[type=text],textarea').focusout(function(event){
        ...
        $('input#ProdCode').bind("keypress change input",function() { 
       ...
       // tblSales
        ...
        $( "#save-product" ).on( "click dblclick", function() { 
               ...
               if($('#hidMRScheme').val() == "Product" && MRNo != "" && (
        ...
        function DisplayButtons(ApproverUserID, MRRole, RequiredVendorConfirmation, ActedDate)
        { 
        ...
        function UpdateStatusAndButton()
        {
           ...
           DisplayButtons(ApproverUserID, MRRole, RequiredVendorConfirmation, ActedDate);
           });
        }
        ...
        function EnabledAccess()
        {
           ...
           if (($('#status-id').val() == "D" || $('#status-id').val() == "R" || $('#status-id').val() == "F" ) && $('#hidMRScheme').val() == "Product" && AllowToChangeApprover == '1')
           {                  
        ...
        function InitialiseMR()
        {
            ...
            $.ajax({
            url: "ApproveMR.aspx/GetRequestorAndApproverList",
            dataType: "json",
            type: "POST",
        ...
        function ConfirmVendor()
        {
            var CoyID = getCoyID(); 
                $.ajax({
                    type: "POST",
                    url: "ApproveMR.aspx/ConfirmVendor",
        ...
        function Approve()
        {
            ...
            { 
                ...
                $.ajax({
                    type: "POST",
                    url: "ApproveMR.aspx/Approve",
                    data: "{ 'CompanyId' : "+CoyID+", 'MRNo': '" +$('#mr-no').val() + "', 'Purchaser' :'" + $('#purchaser').val() + "', 'Reason' :'" + $('#Reason').val().replace("'", "\\'") + "' ,'PageName':'" +  getPageName() + "','UserID': " + getUserID() + ",'CurrentLink':'" +  getCurrentLink() + "','IsCurrentLevel':'" +  getApproverUser() + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
        ...
        { 
            ...
            { 
                ...
                $.ajax({
                    type: "POST",
                    url: "ApproveMR.aspx/SubmitForApproval",
        ...
        {  
            ...
            $.ajax({
                type: "POST",
                url: "ApproveMR.aspx/DuplicateMR",
        ...
        { 
            ...
            $.ajax({
                type: "POST",
                url: "ApproveMR.aspx/"+functionname,
        ...
        function Validation(action)
        {
            ...
            if($('#hidMRScheme').val() == "Product" && !tblProduct.data().count())
            {
        ...
        {           
            ...
            objHeader['mrscheme'] = $('#hidMRScheme').val();  
        ...
        var a = $('#tblSales').DataTable( {
                ...
                "contentType": "application/json; charset=utf-8",
                "type": "POST",
                "url": "ApproveMR.aspx/GetConfirmedSales",
            ...
            "columns": [
                ...
                { 
                    ...
                    "render": function (data, type, row){
                        return "<button type='button' id='confirmedSalesEdit' onclick=\"return false;\" value='"+row.FileID+"' name='Edit' class='glyphicon glyphicon-pencil button-icon "+ $('#hidAllowChanges').val()+ "' "+$('#hidAllowChanges').val()+"></button>&nbsp;<button type='button' id='confirmedSalesDelete' onclick=\"return false;\"  value='"+row.FileID+"' name='Delete' class='glyphicon glyphicon-trash button-icon delete "+ $('#hidAllowChanges').val()+ "' "+$('#hidAllowChanges').val()+"></button>";
                    }
                }              
            ],
            "columnDefs": [ {
        ...
        var a = $('#tblVendor').DataTable( {
            ...
            "columns": [     
                ...
                { 
                    ...
                    "title":"Action", 
                    "render": function (data, type, row){
                        return "<button type='button' onclick=\"return false;\"  value='"+row.VendorID+"' name='Edit' class='glyphicon glyphicon-pencil button-icon "+ $('#hidAllowChanges').val()+ "' "+$('#hidAllowChanges').val()+"></button>&nbsp;<button type='button' onclick=\"return false;\"  value='"+row.VendorID+"' name='Delete' class='glyphicon glyphicon-trash button-icon delete "+ $('#hidAllowChanges').val()+ "' "+$('#hidAllowChanges').val()+"></button>";
                    }
                }                
            ],
            "columnDefs": [{
        ...
        var a = $('#tblProduct').DataTable( {
            ...
            "columns": [   
                ...
                { 
                    ...
                    "title":"Action",                                         
                    "render": function (data, type, row){
                        return "<button type='button' onclick=\"return false;\"  value='"+row.DetailNo+"' name='Edit' class='glyphicon glyphicon-pencil button-icon "+ $('#hidAllowChanges').val()+ "' "+$('#hidAllowChanges').val()+"></button>&nbsp;<button type='button' onclick=\"return false;\"  value='"+row.DetailNo+"' name='Delete' class='glyphicon glyphicon-trash button-icon delete "+ $('#hidAllowChanges').val()+ "' "+$('#hidAllowChanges').val()+"></button>";
                    }
                } ,
                /*, 
                { "data": "Approver1" ,
            ...
            "fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
                    ...
                    SubTotal = api.column( 11 ).data().reduce( function (a, b) {
...
//                    SubTotal = SubTotal + (aData['UnitPurchasePrice']*aData['OrderQty']); 
        ...
        if($('#hidViewPurchaseInfo').val() == "1")
            a.columns([9,10,11]).visible(true);  
    } 
    ...
    function Delivery(){
        ...
        var a = $('#tblDelivery').DataTable( {  
            "ajax": {
                ...
                "contentType": "application/json; charset=utf-8",
                "type": "POST",
                "url": "ApproveMR.aspx/GetDelivery",               
                "data": function (data) { return "{'CompanyId':"+CoyID+",'MRNo':'"+MRNo+"'}";},
                "dataSrc": function (json) {  
                    if(MRNo == undefined || MRNo == '')
                    {
            ...
            "columns": [ 
                ...
                { 
                    ...
                    "title":"Action", 
                    "render": function (data, type, row){
                        return "<button type='button' onclick=\"return false;\"  value='"+row.DeliveryNo+"' name='Edit' class='glyphicon glyphicon-pencil button-icon "+ $('#hidAllowChanges').val()+ "' "+$('#hidAllowChanges').val()+"></button>&nbsp;<button type='button' onclick=\"return false;\"  value='"+row.DeliveryNo+"' name='Delete' class='glyphicon glyphicon-trash button-icon delete "+ $('#hidAllowChanges').val()+ "' "+$('#hidAllowChanges').val()+"></button>";
                    }
                }                          
            ],
            "columnDefs": [ {
    ...
    function Attachment(){
        ...
        var a = $('#tblAttachment').DataTable( {
            "ajax": {
                ...
                "contentType": "application/json; charset=utf-8",
                "type": "POST",
                "url": "ApproveMR.aspx/GetAttachment",               
                "data": function (data) { return "{'CompanyId':"+CoyID+",'MRNo':'"+MRNo+"'}";},
                "dataSrc": function (json) {
            ...
            "columns": [  
                ...
                { 
                    ...
                    "title":"Action", 
                    "render": function (data, type, row){
                        return "<button type='button' onclick=\"return false;\"  value='"+row.FileID+"' name='Edit' class='glyphicon glyphicon-pencil button-icon "+ $('#hidAllowChanges').val()+ "' "+$('#hidAllowChanges').val()+"></button>&nbsp;<button type='button' onclick=\"return false;\"  value='"+row.FileID+"' name='Delete' class='glyphicon glyphicon-trash button-icon delete "+ $('#hidAllowChanges').val()+ "' "+$('#hidAllowChanges').val()+"></button>";
                    }
                }                                          
            ],
            "columnDefs": [ {
     ...
     function RoutingInfo(){
        ...
        var a = $('#tblRouting').DataTable( {
            "ajax": {
                ...
                "contentType": "application/json; charset=utf-8",
                "type": "POST",
                "url": "ApproveMR.aspx/GetRoutingInfo",               
                "data": function (data) { return "{'CompanyId':"+CoyID+",'MRNo':'"+MRNo+"'}";},
                "dataSrc": function (json) {
                    return json;
                 }
    ...
    function GetMRHeader(){   
        ...
        var CoyID = getCoyID();       
         ...
         $.ajax({
            url: "ApproveMR.aspx/GetMRHeader",
            dataType: "json",            
            type: "POST",
            contentType: "application/json; charset=utf-8",
    ...
    function CheckAccess(callback){
       ...
       var MRNo = getMRNo(); 
        ...
        $.ajax({
            async       : true,
            type        : "POST",
            url         : "ApproveMR.aspx/CheckUserAccess",
...
function GetMRHeaderByMRNo(callback){
       ...
       var MRNo = getMRNo();     
        ...
        $.ajax({
            async       : true,
            type        : "POST",
            url         : "ApproveMR.aspx/GetMRHeaderByMRNo",
            data        : "{'CompanyId' : "+CoyID+",'MRNo': '" + MRNo +"'}",
            contentType : "application/json; charset=utf-8",
            dataType    : "json",
            success     : function (data) {
