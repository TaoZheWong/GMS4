<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewGRN.aspx.cs" Inherits="GMSWeb.Products.Products.ViewGRN" Title="MR - View GRN" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>View GRN Detail</title>   
...
<body style="background-image:none; text-align: left" >
    ...
    <input type="hidden" id="hidGRNNo" runat="server" />
    <table class="tTable1" style="margin-left: 8px" cellspacing="5" cellpadding="5" border="0"
        ...
        <tr>
            ...
            <td style="width: 5%">
                :</td>
            <td colspan="2">
                <asp:Label runat="server" ID="lblGRNNo"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="tbLabel">
        ...
        <tr>
            ...
            <td style="width: 5%">
                :</td>
            <td colspan="2">
                <asp:Label runat="server" ID="lblAdd1"></asp:Label><br />
                <asp:Label runat="server" ID="lblAdd2"></asp:Label><br />
