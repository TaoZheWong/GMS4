var MUTED_COLOR = "#8A8A8F",
    ...
    generateSlimScroll = function(e) {
        if (!$(e).attr("data-init")) {
            ...
            /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? ($(e).css("height", t), $(e).css("overflow-x", "scroll")) : $(e).slimScroll(a), $(e).attr("data-init", !0)
        }
    },
    handleHeaderSearchBar = function() {
        $('[data-toggle="search-bar"]').live("click", function(e) {
            ...
            _renderMenu: function(e, t) {
                var a = this;
                $.each(t, function(t, i) {
                    a._renderItem(e, i), 0 == t && e.prepend('<li class="ui-autocomplete-header">Suggested Search:</li>')
                })
            }
        });
        var e = ["Report", "Analytic", "Product", "Project", "Sales", "Mobile App Development", "Build Website", "Helper", "Profile", "Setting"];
    ...
    handleSidebarMenu = function() {
        ...
        $(".sidebar .nav > .has-sub > a").click(function () {
            ...
            e.preventDefault();
            $("#page-container").hasClass("page-sidebar-toggled") ? ($("#page-container").removeClass("page-sidebar-toggled"), $(this).removeClass("active")) : ($("#page-container").addClass("page-sidebar-toggled"), $(this).addClass("active"))
        })
    },
    floatSubMenuTimeout, targetFloatMenu, handleMouseoverFloatSubMenu = function(e) {
        ...
        $(".float-sub-menu li.has-sub > a").live("click", function() {
            ...
            $(e).slideToggle(250, function() {
                var e = $(".float-sub-menu"),
                    t = $(e).height() + 20,
                    a = ($(e).offset(), $(e).attr("data-offset-top"));
                $(window).height() - a > t ? $(".float-sub-menu").css({
                    top: a,
                    bottom: "auto",
                    overflow: "initial"
                }) : $(".float-sub-menu").css({
            ...
            if ($("#page-container").hasClass("page-sidebar-minified")) {
                ...
                if (t) {
                    var a = $(e).height() + 20,
                        ...
                        n = $("#page-container").hasClass("page-sidebar-right") ? "auto" : 60,
                        o = $("#page-container").hasClass("page-sidebar-right") ? 60 : "auto",
                        s = $(window).height();
                    0 == $(".float-sub-menu").length ? (t = '<ul class="float-sub-menu" data-offset-top="' + i + '" onmouseover="handleMouseoverFloatSubMenu(this)" onmouseout="handleMouseoutFloatSubMenu(this)">' + t + "</ul>", $("body").append(t)) : $(".float-sub-menu").html(t), s - i > a ? $(".float-sub-menu").css({
                        top: i,
                        left: n,
                        bottom: "auto",
                        right: o
        ...
        $.extend({
            notification: function(e) {
                var t = e.title ? e.title : "",
                    ...
                    i = e.icon ? e.icon : "",
                    n = e.iconClass ? e.iconClass : "",
                    o = e.img ? e.img : "",
                    s = e.imgClass ? e.imgClass : "",
                    r = e.closeBtn ? e.closeBtn : "",
                    d = (e.closeBtnText && e.closeBtnText, e.btn ? e.btn : ""),
                    l = e.btnText ? e.btnText : "",
                    c = e.btnAttr ? e.btnAttr : "",
                    R = e.btnUrl ? e.btnUrl : "#",
                    _ = e.autoclose ? e.autoclose : "",
                    g = e.autocloseTime ? e.autocloseTime : 5e3,
                    h = e.class ? e.class : "",
                    b = e.inverseMode ? "page-notification-inverse" : "",
                    N = t ? '<h4 class="notification-title">' + t + "</h4>" : "",
                    T = a ? '<p class="notification-desc">' + a + "</p>" : "",
                    A = i ? '<div class="notification-media"><i class="' + i + " " + n + '"></i></div>' : "";
                A = o ? '<div class="notification-media"><img src="' + o + '" class="' + s + '"></i></div>' : A;
                var u = d && l ? '<a href="' + R + '" ' + c + ">" + l + "</a>" : "",
                    O = r && "disabled" == r ? "" : '<a href="#" data-dismiss="notification">Close</a>',
                    p = '<div class="page-notification ' + h + " bounceInRight animated " + b + '">' + A + (N || T ? '<div class="notification-info">' + N + T + "</div>" : "") + ('<div class="notification-btn ' + (!u && O || u && !O ? "single-btn" : "") + '">' + u + O + "</div>") + "</div>";
                if (0 === $("#page-notification-container").length && $("body").append('<div id="page-notification-container" class="page-notification-container"></div>'), $("#page-notification-container").append(p), _) {
                    var f = $("#page-notification-container").find(".page-notification").last();
                    setTimeout(function() {
                        $(f).notification("destroy")
                    }, g)
                }
            }
    ...
    handleSettingCookie = function() {
        $("#setting_sidebar_inverse").live("change", function() {
            $(this).is(":checked") ? (Cookies.set("sidebar-inverse", "true"), $("#sidebar").addClass("sidebar-inverse")) : (Cookies.set("sidebar-inverse", "false"), $("#sidebar").removeClass("sidebar-inverse"))
        }), "false" == Cookies.get("sidebar-inverse") ? ($("#setting_sidebar_inverse").prop("checked", !1), $("#setting_sidebar_inverse").trigger("change")) : ($("#setting_sidebar_inverse").prop("checked", !0), $("#setting_sidebar_inverse").trigger("change")),

        $("#setting_sidebar_minified").live("click", function () {
            var pageContainer = $("#page-container");

            if (pageContainer.hasClass("page-sidebar-minified"))
                (Cookies.set("sidebar-minified", "false"), $(this).attr("data-minified", "false"), $("#page-container").removeClass("page-sidebar-minified"));
            else
                (Cookies.set("sidebar-minified", "true"), $(this).attr("data-minified", "true"), $("#page-container").addClass("page-sidebar-minified"));
        }), "true" == Cookies.get("sidebar-minified") ? ($(this).attr("data-minified", "true"), $("#page-container").addClass("page-sidebar-minified")) : ($(this).attr("data-minified", "false"), $("#page-container").removeClass("page-sidebar-minified")) ,
        $("#setting_layout_biggerFont").live("change", function () {
            var body = $("body");
            $(this).is(":checked") ? (Cookies.set("isLargeFont", "true"), body.addClass("largeFont")) : (Cookies.set("isLargeFont", "false"), body.removeClass("largeFont"))
                
        }), "true" == Cookies.get("isLargeFont") ? ($("#setting_layout_biggerFont").prop("checked", !0), $("#setting_layout_biggerFont").trigger("change")) : ($("#setting_layout_biggerFont").prop("checked", !1), $("#setting_layout_biggerFont").trigger("change")),
        $("#setting_layout_optimize_table").live("change", function () {
            var body = $("body");
            $(this).is(":checked") ? (Cookies.set("isOptimizedTable", "true"), body.addClass("optimizedTable")) : (Cookies.set("isOptimizedTable", "false"), body.removeClass("optimizedTable"))

        }), "true" == Cookies.get("isOptimizedTable") ? ($("#setting_layout_optimize_table").prop("checked", !0), $("#setting_layout_optimize_table").trigger("change")) : ($("#setting_layout_optimize_table").prop("checked", !1), $("#setting_layout_optimize_table").trigger("change")),
        /*
        $("#setting_sidebar_minified").live("change", function () {
            console.log("hello world");
            $(this).is(":checked") ? (Cookies.set("sidebar-minified", "true"), $("#page-container").addClass("page-sidebar-minified")) : (Cookies.set("sidebar-minified", "false"), $("#page-container").removeClass("page-sidebar-minified"))
        }), "true" == Cookies.get("sidebar-minified") ? ($("#setting_sidebar_minified").prop("checked", !0), $("#setting_sidebar_minified").trigger("change")) : ($("#setting_sidebar_minified").prop("checked", !1), $("#setting_sidebar_minified").trigger("change")),
        */
        $("#setting_header_inverse").live("change", function () {
            $(this).is(":checked") ? (Cookies.set("header-inverse", "true"), $("#header").removeClass("navbar-default").addClass("navbar-inverse")) : (Cookies.set("header-inverse", "false"), $("#header").removeClass("navbar-inverse").addClass("navbar-default"))
        }), "false" == Cookies.get("header-inverse") ? ($("#setting_header_inverse").prop("checked", !1), $("#setting_header_inverse").trigger("change")) : ($("#setting_header_inverse").prop("checked", !0), $("#setting_header_inverse").trigger("change")), $("#setting_fixed_header").live("change", function() {
            $(this).is(":checked") ? (Cookies.set("header-fixed", "true"), $("#header").addClass("navbar-fixed-top"), $("#page-container").addClass("page-header-fixed")) : ($("#setting_fixed_sidebar").is(":checked") && (alert("Default Header with Fixed Sidebar option is not supported. Proceed with Default Header with Default Sidebar."), $("#setting_fixed_sidebar").prop("checked", !1), $("#setting_fixed_sidebar").trigger("change")), Cookies.set("header-fixed", "false"), $("#header").removeClass("navbar-fixed-top"), $("#page-container").removeClass("page-header-fixed"))
        }), "false" == Cookies.get("header-fixed") ? ($("#setting_fixed_header").prop("checked", !1), $("#setting_fixed_header").trigger("change")) : ($("#setting_fixed_header").prop("checked", !0), $("#setting_fixed_header").trigger("change")), $("#setting_fixed_sidebar").live("change", function() {
            $(this).is(":checked") ? ($("#setting_fixed_header").is(":checked") || (alert("Default Header with Fixed Sidebar option is not supported. Proceed with Fixed Header with Fixed Sidebar."), $("#setting_fixed_header").prop("checked", !0), $("#setting_fixed_header").trigger("change")), Cookies.set("sidebar-fixed", "true"), $("#page-container").addClass("page-sidebar-fixed"), $('.sidebar [data-scrollbar="true"]').removeAttr("data-init"), generateSlimScroll($('.sidebar [data-scrollbar="true"]'))) : (Cookies.set("sidebar-fixed", "false"), $("#page-container").removeClass("page-sidebar-fixed"), $('.sidebar [data-scrollbar="true"]').slimScroll({
                destroy: !0
            }), $('.sidebar [data-scrollbar="true"]').removeAttr("style"))
        }), "false" == Cookies.get("sidebar-fixed") ? ($("#setting_fixed_sidebar").prop("checked", !1), $("#setting_fixed_sidebar").trigger("change")) : ($("#setting_fixed_sidebar").prop("checked", !0), $("#setting_fixed_sidebar").trigger("change"))
    },
    ...
    handlePanelAction = function() {
        ...
        panelActionRunning = !0, $(document).on("hover", "[data-toggle=panel-remove]", function(e) {
            ...
            if (!$(t).hasClass("panel-loading")) {
                ...
                $(t).addClass("panel-loading"), $(a).prepend('<div class="panel-loading"><div class="spinner"></div></div>'), setTimeout(function() {
            ...
            if ($("body").hasClass("panel-expand") && $(t).hasClass("panel-expand")) $("body, .panel").removeClass("panel-expand"), $(".panel").removeAttr("style"), $(a).removeAttr("style");
            else if ($("body").addClass("panel-expand"), $(this).closest(".panel").addClass("panel-expand"), 0 !== $(a).length && 40 != i) {
                var o = 40;
    ...
    handleScrollToTopButton = function() {
        ...
        $(document).scroll(function() {
            ...
            $(".content").scrollTop() >= 200 ? $("[data-click=scroll-top]").addClass("in") : $("[data-click=scroll-top]").removeClass("in")
    ...
    handleCompanySideBar = function () {
        $("[data-control=company-sidebar]").click(function (e) {
            e.preventDefault();
            var sidebar = $(".company-sidebar-wrapper")
    ...
    App = function() {
        ...
        return {
            init: function() {
                this.initSidebar(), this.initHeader(), this.initComponent(), this.initCookie(), this.initCompanySideBar()
            },
            initSidebar: function() {
                handleSidebarMinifyFloatMenu(), handleSidebarMenu()
            },
            initHeader: function() {
            ...
            initCompanySideBar : function(){
                handleCompanySideBar()
            },
            scrollTop: function() {
