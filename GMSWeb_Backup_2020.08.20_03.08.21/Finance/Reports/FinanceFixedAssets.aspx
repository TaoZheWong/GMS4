<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="FinanceFixedAssets.aspx.cs" Inherits="GMSWeb.Finance.Reports.FinanceFixedAssets" %>
...
<ul class="breadcrumb pull-right">
    <li class="active">Fixed Assets Reports</li>
</ul>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            $(".fixed-menu").addClass("active expand");
            $(".sub-fixed").addClass("active");
        });
    </script>
</asp:Content>
