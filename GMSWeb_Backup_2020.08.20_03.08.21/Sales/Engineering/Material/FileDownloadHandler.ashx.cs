...
namespace GMSWeb.Sales.Engineering.Material
{
    ...
    public class FileDownloadHandler : IHttpHandler
    {
        ...
        {            
            ...
            string OriFileName = context.Request.QueryString["OriFileName"];
            ...
            context.Response.TransmitFile(System.Web.Configuration.WebConfigurationManager.AppSettings["PRJ_DOWNLOAD_PATH"].ToString() + CompanyId + "\\" + FileName);
