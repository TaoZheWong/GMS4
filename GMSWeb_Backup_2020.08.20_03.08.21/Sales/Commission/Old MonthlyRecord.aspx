<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Old MonthlyRecord.aspx.cs" Inherits="GMSWeb.Sales.Commission.MonthlyRecord" %>
...
<head id="Head1" runat="server">
    <title>Commission - Monthly Records</title>
...
<body>
    ...
    <asp:ScriptManager ID="sriptmgr1" runat="server">
        ...
        <div id="GroupContentBar">
            <h3>
                Commission &gt; Monthly Records</h3>
            List of monthly commission records by salesman.
            <br />
            <br />
