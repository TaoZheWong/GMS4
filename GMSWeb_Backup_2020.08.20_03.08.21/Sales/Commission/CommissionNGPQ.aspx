<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="CommissionNGPQ1.aspx.cs" Inherits="GMSWeb.Sales.Commission.CommissionNGPQ" Title="Sales - Commission and GPQ Page" %>
<%@ MasterType VirtualPath="~/Common/Site.Master"%> 
<%@ Register TagPrefix="uctrl" TagName="MsgPanel" Src="~/CustomCtrl/MessagePanelControl.ascx" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
<asp:ScriptManager ID="sriptmgr1" runat="server"></asp:ScriptManager>
<h1>Commission &gt; Commission Rate & GPQ</h1>
<p>Master record of commission rate and GPQ.</p>
        ...
        <td>
            ...
            <div>
                <asp:DataGrid ID="dgData" runat="server" AutoGenerateColumns="false" ShowFooter="true"
                    ...
                    CellPadding="5" CellSpacing="5" CssClass="tTable tBorder" AllowPaging="true"
                    PageSize="20" OnPageIndexChanged="dgData_PageIndexChanged" EnableViewState="true" Width="750px">
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="Salesman Name" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <EditItemTemplate>
                                <asp:TextBox CssClass="textbox" ID="txtEditSalesPersonMasterName" runat="server" Columns="20" MaxLength="50" onchange="this.value = this.value.toUpperCase()" Text='<%# Eval( "SalesPersonMasterName" )%>' /><asp:RequiredFieldValidator
                            ...
                            <FooterTemplate>
                                <asp:TextBox CssClass="textbox" ID="txtNewSalesPersonMasterName" runat="server" Columns="20" MaxLength="50" onchange="this.value = this.value.toUpperCase()" /><asp:RequiredFieldValidator
                        ...
                        <asp:TemplateColumn HeaderText="Accounts List" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <EditItemTemplate>
                                <asp:TextBox CssClass="textbox" ID="txtEditAccountList" runat="server" Columns="30" MaxLength="100" ReadOnly="true" Text='<%# Eval( "AccountList" )%>'/><asp:ImageButton ID="lnkEditAccount"
                            ...
                            <FooterTemplate>
                                <asp:TextBox CssClass="textbox" ID="txtNewAccountList" runat="server" Columns="30" MaxLength="100" ReadOnly="true"/><asp:ImageButton ID="lnkAddAccount"
                        ...
                        <asp:TemplateColumn HeaderText="GPQ" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false"
                            ...
                            <EditItemTemplate>
                                <asp:TextBox CssClass="textbox" ID="txtEditGPQ" runat="server" Columns="10" MaxLength="10" Text='<%# Eval("GPQ") %>' /><asp:RequiredFieldValidator
                            ...
                            <FooterTemplate>
                                <asp:TextBox CssClass="textbox" ID="txtNewGPQ" runat="server" Columns="10" MaxLength="10" /><asp:RequiredFieldValidator
                        ...
                        <asp:TemplateColumn HeaderText="Comm Rate" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false"
                            ...
                            <EditItemTemplate>
                                <asp:TextBox CssClass="textbox" ID="txtEditCommissionRate" runat="server" Columns="10" MaxLength="10"
                            ...
                            <FooterTemplate>
                                <asp:TextBox CssClass="textbox" ID="txtNewCommissionRate" runat="server" Columns="10" MaxLength="10" /><asp:RequiredFieldValidator
...
<asp:Panel ID="PNL" runat="server" Style="display: none; width: 300px; background-color: White;
    ...
    <div style="text-align: center;">
        <table>
            ...
            <tr>
                <td style="width: 25px">
                    <asp:ListBox ID="lsbAccounts" runat="server" SelectionMode="Multiple" Rows="30" Width="250px"
