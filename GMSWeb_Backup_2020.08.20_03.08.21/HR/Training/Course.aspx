<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" CodeBehind="Course.aspx.cs" Inherits="GMSWeb.HR.Training.Course"Title="Training - Course" %>
<%@ MasterType VirtualPath="~/Common/Site.Master"%> 
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <h1 class="page-header">Course 
        <br />
        <small>Main page for Course.</small>
    </h1>
