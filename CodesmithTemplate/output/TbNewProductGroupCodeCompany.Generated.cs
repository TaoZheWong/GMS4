...
{
	///<summary>Database mapping to table tbNewProductGroupCodeCompany</summary>
	[DataObject(true)]
    public partial class TbNewProductGroupCodeCompany : PersistBase<TbNewProductGroupCodeCompany>, IObjectHelper
	{
		#region Properties
	
		private short _coyID = 0;
		///<summary>Database mapping to column tbNewProductGroupCodeCompany.CoyID</summary>
		public short CoyID
		{
			get { return _coyID; }
			set
		...
		public TbNewProductGroupCodeCompany() : base()
		{
			// Default Constructor
		}
