...
{
	///<summary>Database mapping to table tbUserAccessModule_ToDelete</summary>
	[DataObject(true)]
    public partial class ToDelete4 : PersistBase<ToDelete4>, IObjectHelper
	{
		#region Properties
	
		private short _userNumID;
		///<summary>Database mapping to column tbUserAccessModule_ToDelete.UserNumID</summary>
		...
		///<summary>Database mapping to column tbUserAccessModule_ToDelete.ModuleID</summary>
		[DataObjectField(true, false)]
        ...
        public static ToDelete4 RetrieveByKey(short userNumID, short moduleID)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("ToDelete4.UserNumID", userNumID);
			where += " and ";
			where += helper.GetExpression("ToDelete4.ModuleID", moduleID);
