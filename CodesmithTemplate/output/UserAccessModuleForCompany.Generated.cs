...
{
	///<summary>Database mapping to table tbUserAccessModuleForCompany</summary>
	[DataObject(true)]
    public partial class UserAccessModuleForCompany : PersistBase<UserAccessModuleForCompany>, IObjectHelper
	{
		#region Properties
	
		private short _coyID;
		///<summary>Database mapping to column tbUserAccessModuleForCompany.CoyID</summary>
		...
		///<summary>Database mapping to column tbUserAccessModuleForCompany.UserNumID</summary>
		[DataObjectField(true, false)]
		...
		///<summary>Database mapping to column tbUserAccessModuleForCompany.ModuleID</summary>
		[DataObjectField(true, false)]
		...
		public UserAccessModuleForCompany() : base()
		{
			// Default Constructor
		}
        ...
        public static UserAccessModuleForCompany RetrieveByKey(short coyID, short userNumID, short moduleID)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("UserAccessModuleForCompany.CoyID", coyID);
			where += " and ";
			where += helper.GetExpression("UserAccessModuleForCompany.UserNumID", userNumID);
			where += " and ";
			where += helper.GetExpression("UserAccessModuleForCompany.ModuleID", moduleID);
        ...
        public static int DeleteByKey(short coyID, short userNumID, short moduleID)
		{			
			DBManager db = DBManager.GetInstance();		
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("UserAccessModuleForCompany.CoyID", coyID);
		...
		public static int DeleteByKey(Wilson.ORMapper.Transaction transaction, short coyID, short userNumID, short moduleID)
		{			
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("UserAccessModuleForCompany.CoyID", coyID);
