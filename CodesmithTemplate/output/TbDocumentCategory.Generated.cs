...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class TbDocumentCategory : PersistBase<TbDocumentCategory>, IObjectHelper
	{
		#region Properties
		...
		public TbDocumentCategory() : base()
		{
			// Default Constructor
		}
		///<summary>Initializes a new instance of this class</summary>
		///<param name="startTracking">Set to true to begin ORMapper tracking on this instance</param>
		public TbDocumentCategory(bool startTracking) : base(startTracking)
		{
        ...
        public static TbDocumentCategory RetrieveByKey(short documentCategoryID)
		{
			DBManager db = DBManager.GetInstance();
			return db.Engine.GetObject<TbDocumentCategory>(documentCategoryID);
		}
		...
		{			
			...
			string where = helper.GetExpression("TbDocumentCategory.DocumentCategoryID", documentCategoryID);
