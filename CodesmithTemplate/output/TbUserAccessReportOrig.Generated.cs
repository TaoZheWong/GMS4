...
{
	///<summary>Database mapping to table tbUserAccessReportOrig</summary>
	[DataObject(true)]
    public partial class TbUserAccessReportOrig : PersistBase<TbUserAccessReportOrig>, IObjectHelper
	{
		#region Properties
	
		private short _userNumID;
		///<summary>Database mapping to column tbUserAccessReportOrig.UserNumID</summary>
		...
		///<summary>Database mapping to column tbUserAccessReportOrig.ReportID</summary>
		[DataObjectField(true, false)]
		...
		public TbUserAccessReportOrig() : base()
		{
			// Default Constructor
		}
        ...
        public static TbUserAccessReportOrig RetrieveByKey(short userNumID, short reportID)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbUserAccessReportOrig.UserNumID", userNumID);
			where += " and ";
			where += helper.GetExpression("TbUserAccessReportOrig.ReportID", reportID);
