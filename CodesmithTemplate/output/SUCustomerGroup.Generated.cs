...
{
	///<summary>Database mapping to table SUCustomerGroup</summary>
	[DataObject(true)]
    public partial class SUCustomerGroup : PersistBase<SUCustomerGroup>, IObjectHelper
	{
		#region Properties
	
		private string _code;
		///<summary>Database mapping to column SUCustomerGroup.Code</summary>
		public string Code
		{
			get { return _code; }
			set
		...
		///<summary>Database mapping to column SUCustomerGroup.Description</summary>
