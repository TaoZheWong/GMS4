...
{
	///<summary>Database mapping to table tbTestData</summary>
	[DataObject(true)]
    public partial class TbTestData : PersistBase<TbTestData>, IObjectHelper
	{
		#region Properties
	
		private byte _coyID;
		///<summary>Database mapping to column tbTestData.CoyID</summary>
		public byte CoyID
		{
			get { return _coyID; }
			set
		...
		///<summary>Database mapping to column tbTestData.CreatedDate</summary>
