...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class TbProductGroup : PersistBase<TbProductGroup>, IObjectHelper
	{
		#region Properties
        ...
        public static TbProductGroup RetrieveByKey(short coyID, string productGroupCode)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbProductGroup.CoyID", coyID);
			where += " and ";
			where += helper.GetExpression("TbProductGroup.ProductGroupCode", productGroupCode);
