...
namespace GMSCore.Entity
{
    ...
    {        
        ...
        public static T RetrieveFirst(OPathQuery<T> query)
        {
            ...
            return db.Engine.GetObject<T>(query);
        }
        ...
        {
			DBManager db = DBManager.GetInstance();
            return db.Engine.GetObject<T>(query, parameters);
        }
        #endregion
        ...
        {
			DBManager db = DBManager.GetInstance();
            return db.Engine.GetObjectSet(query);
        }
        ...
        {
			DBManager db = DBManager.GetInstance();
            return db.Engine.GetObjectSet(query, parameters);
        }
        ...
        {
			DBManager db = DBManager.GetInstance();
            return db.Engine.GetObjectSet(compiledQuery);
        }
        ...
        {
			DBManager db = DBManager.GetInstance();
            return db.Engine.GetObjectSet(compiledQuery, parameters);
        }
        ...
        public static ObjectSet<T> RetrieveCachedQuery(ObjectQuery<T> query)
        {
            ...
            if (cachedSet == null)
            {
				...
				DBManager db = DBManager.GetInstance();
                string tableName = db.Engine.QueryHelper.GetTableName(typeof(T).Name);
                //TODO: Change as needed
                System.Web.Caching.SqlCacheDependency dependency = new System.Web.Caching.SqlCacheDependency(db.DatabaseName, tableName);
        ...
        public T Resync()
        {
            ...
            return (T)db.Engine.Resync(this);
        }
        ...
        {
			DBManager db = DBManager.GetInstance();
            return db.Engine.GetObjectCount<T>(string.Empty);
        }
