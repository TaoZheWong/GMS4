...
{
	///<summary>Database mapping to table tbUserExcludeMonthEndDisableAccess</summary>
	[DataObject(true)]
    public partial class TbUserExcludeMonthEndDisableAccess : PersistBase<TbUserExcludeMonthEndDisableAccess>, IObjectHelper
	{
		#region Properties
	
		private short _userNumID = 0;
		///<summary>Database mapping to column tbUserExcludeMonthEndDisableAccess.UserNumID</summary>
		...
		public TbUserExcludeMonthEndDisableAccess() : base()
		{
			// Default Constructor
		}
