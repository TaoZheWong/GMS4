...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class UserAccessCompany : PersistBase<UserAccessCompany>, IObjectHelper
	{
		#region Properties
        ...
        public static UserAccessCompany RetrieveByKey(short userNumID, short coyID)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("UserAccessCompany.UserNumID", userNumID);
			where += " and ";
			where += helper.GetExpression("UserAccessCompany.CoyID", coyID);
