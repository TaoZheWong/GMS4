...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class TbUserAccessDocumentOperation : PersistBase<TbUserAccessDocumentOperation>, IObjectHelper
	{
		#region Properties
		...
		public TbUserAccessDocumentOperation() : base()
		{
			// Default Constructor
		}
        ...
        public static TbUserAccessDocumentOperation RetrieveByKey(short userNumID, short moduleCategoryID)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbUserAccessDocumentOperation.UserNumID", userNumID);
			where += " and ";
			where += helper.GetExpression("TbUserAccessDocumentOperation.ModuleCategoryID", moduleCategoryID);
