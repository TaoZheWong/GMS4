...
{
	///<summary>Database mapping to table tbUserAccessCompany</summary>
	[DataObject(true)]
    public partial class TbUserAccessCompany : PersistBase<TbUserAccessCompany>, IObjectHelper
	{
		#region Properties
	
		private short _userNumID;
		///<summary>Database mapping to column tbUserAccessCompany.UserNumID</summary>
		...
		///<summary>Database mapping to column tbUserAccessCompany.CoyID</summary>
		[DataObjectField(true, false)]
		public short CoyID
		{
			get { return _coyID; }
		...
		public TbUserAccessCompany() : base()
		{
			// Default Constructor
		}
        ...
        public static TbUserAccessCompany RetrieveByKey(short userNumID, short coyID)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbUserAccessCompany.UserNumID", userNumID);
			where += " and ";
			where += helper.GetExpression("TbUserAccessCompany.CoyID", coyID);
        ...
        public static int DeleteByKey(short userNumID, short coyID)
		{			
			DBManager db = DBManager.GetInstance();		
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbUserAccessCompany.UserNumID", userNumID);
		...
		public static int DeleteByKey(Wilson.ORMapper.Transaction transaction, short userNumID, short coyID)
		{			
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbUserAccessCompany.UserNumID", userNumID);
