...
{
	///<summary>Database mapping to table tbAccountExcludeBadDebt</summary>
	[DataObject(true)]
    public partial class TbAccountExcludeBadDebt : PersistBase<TbAccountExcludeBadDebt>, IObjectHelper
	{
		#region Properties
	
		private short _coyID;
		///<summary>Database mapping to column tbAccountExcludeBadDebt.CoyID</summary>
		public short CoyID
		{
			get { return _coyID; }
			set
		...
		///<summary>Database mapping to column tbAccountExcludeBadDebt.AccountCode</summary>
		...
		public TbAccountExcludeBadDebt() : base()
		{
			// Default Constructor
		}
