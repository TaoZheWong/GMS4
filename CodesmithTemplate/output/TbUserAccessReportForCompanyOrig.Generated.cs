...
{
	///<summary>Database mapping to table tbUserAccessReportForCompanyOrig</summary>
	[DataObject(true)]
    public partial class TbUserAccessReportForCompanyOrig : PersistBase<TbUserAccessReportForCompanyOrig>, IObjectHelper
	{
		#region Properties
	
		private short _coyID;
		///<summary>Database mapping to column tbUserAccessReportForCompanyOrig.CoyID</summary>
		...
		///<summary>Database mapping to column tbUserAccessReportForCompanyOrig.UserNumID</summary>
		[DataObjectField(true, false)]
		...
		///<summary>Database mapping to column tbUserAccessReportForCompanyOrig.ReportID</summary>
		[DataObjectField(true, false)]
		...
		public TbUserAccessReportForCompanyOrig() : base()
		{
			// Default Constructor
		}
        ...
        public static TbUserAccessReportForCompanyOrig RetrieveByKey(short coyID, short userNumID, short reportID)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbUserAccessReportForCompanyOrig.CoyID", coyID);
			where += " and ";
			where += helper.GetExpression("TbUserAccessReportForCompanyOrig.UserNumID", userNumID);
			where += " and ";
			where += helper.GetExpression("TbUserAccessReportForCompanyOrig.ReportID", reportID);
        ...
        public static int DeleteByKey(short coyID, short userNumID, short reportID)
		{			
			DBManager db = DBManager.GetInstance();		
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbUserAccessReportForCompanyOrig.CoyID", coyID);
		...
		public static int DeleteByKey(Wilson.ORMapper.Transaction transaction, short coyID, short userNumID, short reportID)
		{			
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbUserAccessReportForCompanyOrig.CoyID", coyID);
