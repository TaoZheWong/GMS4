...
{
	///<summary>Database mapping to table tmpADPLMigratedPO</summary>
	[DataObject(true)]
    public partial class TmpADPLMigratedPO : PersistBase<TmpADPLMigratedPO>, IObjectHelper
	{
		#region Properties
	
		private string _dONo = "";
		///<summary>Database mapping to column tmpADPLMigratedPO.DONo</summary>
		public string DONo
		{
			get { return _dONo; }
			set
		...
		///<summary>Database mapping to column tmpADPLMigratedPO.CustomerPO</summary>
