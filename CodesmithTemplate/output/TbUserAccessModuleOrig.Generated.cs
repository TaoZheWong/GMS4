...
{
	///<summary>Database mapping to table tbUserAccessModuleOrig</summary>
	[DataObject(true)]
    public partial class TbUserAccessModuleOrig : PersistBase<TbUserAccessModuleOrig>, IObjectHelper
	{
		#region Properties
	
		private short _userNumID;
		///<summary>Database mapping to column tbUserAccessModuleOrig.UserNumID</summary>
		...
		///<summary>Database mapping to column tbUserAccessModuleOrig.ModuleID</summary>
		...
		public TbUserAccessModuleOrig() : base()
		{
			// Default Constructor
		}
