...
{
	///<summary>Database mapping to table EmployeeMY</summary>
	[DataObject(true)]
    public partial class EmployeeMY : PersistBase<EmployeeMY>, IObjectHelper
	{
		#region Properties
	
		private string _old = "";
		///<summary>Database mapping to column EmployeeMY.Old</summary>
		public string Old
		{
			get { return _old; }
			set
		...
		private string _new = "";
		///<summary>Database mapping to column EmployeeMY.New</summary>
		public string New
		{
			get { return _new; }
			set
