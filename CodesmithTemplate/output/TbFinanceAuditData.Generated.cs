...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class TbFinanceAuditData : PersistBase<TbFinanceAuditData>, IObjectHelper
	{
		#region Properties
		...
		public TbFinanceAuditData() : base()
		{
			// Default Constructor
		}
        ...
        public static TbFinanceAuditData RetrieveByKey(short coyID, short tbYear, short itemID)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbFinanceAuditData.CoyID", coyID);
			where += " and ";
			where += helper.GetExpression("TbFinanceAuditData.TbYear", tbYear);
			where += " and ";
			where += helper.GetExpression("TbFinanceAuditData.ItemID", itemID);
