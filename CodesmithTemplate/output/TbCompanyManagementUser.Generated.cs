...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class TbCompanyManagementUser : PersistBase<TbCompanyManagementUser>, IObjectHelper
	{
		#region Properties
		...
		public TbCompanyManagementUser() : base()
		{
			// Default Constructor
		}
        ...
        public static TbCompanyManagementUser RetrieveByKey(short coyID, short mGUserID)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbCompanyManagementUser.CoyID", coyID);
			where += " and ";
			where += helper.GetExpression("TbCompanyManagementUser.MGUserID", mGUserID);
