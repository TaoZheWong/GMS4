...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class UserAccessReport : PersistBase<UserAccessReport>, IObjectHelper
	{
		#region Properties
        ...
        public static UserAccessReport RetrieveByKey(short userNumID, short reportID)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("UserAccessReport.UserNumID", userNumID);
			where += " and ";
			where += helper.GetExpression("UserAccessReport.ReportID", reportID);
