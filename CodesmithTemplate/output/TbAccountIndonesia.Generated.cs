...
{
	///<summary>Database mapping to table tbAccountIndonesia</summary>
	[DataObject(true)]
    public partial class TbAccountIndonesia : PersistBase<TbAccountIndonesia>, IObjectHelper
	{
		#region Properties
	
		private short _coyID;
		///<summary>Database mapping to column tbAccountIndonesia.CoyID</summary>
		...
		///<summary>Database mapping to column tbAccountIndonesia.AccountCode</summary>
		[DataObjectField(true, false)]
		...
		public TbAccountIndonesia() : base()
		{
			// Default Constructor
		}
        ...
        public static TbAccountIndonesia RetrieveByKey(short coyID, string accountCode)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbAccountIndonesia.CoyID", coyID);
			where += " and ";
			where += helper.GetExpression("TbAccountIndonesia.AccountCode", accountCode);
