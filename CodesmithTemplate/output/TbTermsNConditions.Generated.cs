...
{
	///<summary>Database mapping to table tbTermsNConditions</summary>
	[DataObject(true)]
    public partial class TbTermsNConditions : PersistBase<TbTermsNConditions>, IObjectHelper
	{
		#region Properties
	
		private string _name = "";
		///<summary>Database mapping to column tbTermsNConditions.Name</summary>
		public string Name
		{
			get { return _name; }
			set
		...
		public TbTermsNConditions() : base()
		{
			// Default Constructor
		}
