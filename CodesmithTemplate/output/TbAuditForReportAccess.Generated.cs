...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class TbAuditForReportAccess : PersistBase<TbAuditForReportAccess>, IObjectHelper
	{
		#region Properties
		...
		public TbAuditForReportAccess() : base()
		{
			// Default Constructor
		}
        ...
        public static TbAuditForReportAccess RetrieveByKey(short coyID, short userID, short reportID, DateTime accessDate)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbAuditForReportAccess.CoyID", coyID);
			where += " and ";
			where += helper.GetExpression("TbAuditForReportAccess.UserID", userID);
			where += " and ";
			where += helper.GetExpression("TbAuditForReportAccess.ReportID", reportID);
			where += " and ";
			where += helper.GetExpression("TbAuditForReportAccess.AccessDate", accessDate);
