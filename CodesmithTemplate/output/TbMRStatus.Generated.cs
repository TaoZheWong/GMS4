...
{
	///<summary>Database mapping to table tbMRStatus</summary>
	[DataObject(true)]
    public partial class TbMRStatus : PersistBase<TbMRStatus>, IObjectHelper
	{
		#region Properties
	
		private string _statusID;
		///<summary>Database mapping to column tbMRStatus.StatusID</summary>
		...
		///<summary>Database mapping to column tbMRStatus.StatusName</summary>
