...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class TbSalesPersonUser : PersistBase<TbSalesPersonUser>, IObjectHelper
	{
		#region Properties
        ...
        public static TbSalesPersonUser RetrieveByKey(short coyID, string salesPersonID, short userID)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbSalesPersonUser.CoyID", coyID);
			where += " and ";
			where += helper.GetExpression("TbSalesPersonUser.SalesPersonID", salesPersonID);
			where += " and ";
			where += helper.GetExpression("TbSalesPersonUser.UserID", userID);
