...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class TbGroupManagementUser : PersistBase<TbGroupManagementUser>, IObjectHelper
	{
		#region Properties
		...
		public TbGroupManagementUser() : base()
		{
			// Default Constructor
		}
        ...
        public static TbGroupManagementUser RetrieveByKey(short mGUserID)
		{
			DBManager db = DBManager.GetInstance();
			return db.Engine.GetObject<TbGroupManagementUser>(mGUserID);
		}
		...
		{			
			...
			string where = helper.GetExpression("TbGroupManagementUser.MGUserID", mGUserID);
