...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class TbDocumentForCompany : PersistBase<TbDocumentForCompany>, IObjectHelper
	{
		#region Properties
		...
		public TbDocumentForCompany() : base()
		{
			// Default Constructor
		}
		///<summary>Initializes a new instance of this class</summary>
		///<param name="startTracking">Set to true to begin ORMapper tracking on this instance</param>
		public TbDocumentForCompany(bool startTracking) : base(startTracking)
		{
        ...
        public static TbDocumentForCompany RetrieveByKey(short documentID)
		{
			DBManager db = DBManager.GetInstance();
			return db.Engine.GetObject<TbDocumentForCompany>(documentID);
		}
		...
		{			
			...
			string where = helper.GetExpression("TbDocumentForCompany.DocumentID", documentID);
