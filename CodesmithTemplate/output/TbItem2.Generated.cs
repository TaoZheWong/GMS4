...
{
	///<summary>Database mapping to table tbItem2</summary>
	[DataObject(true)]
    public partial class TbItem2 : PersistBase<TbItem2>, IObjectHelper
	{
		#region Properties
	
		private short _itemID;
		///<summary>Database mapping to column tbItem2.ItemID</summary>
		public short ItemID
		{
			get { return _itemID; }
			set
		...
		///<summary>Database mapping to column tbItem2.ItemName</summary>
		...
		///<summary>Database mapping to column tbItem2.CreatedBy</summary>
		...
		///<summary>Database mapping to column tbItem2.CreatedDate</summary>
		...
		///<summary>Database mapping to column tbItem2.ModifiedBy</summary>
		...
		///<summary>Database mapping to column tbItem2.ModifiedDate</summary>
