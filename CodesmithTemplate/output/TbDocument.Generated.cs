...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class TbDocument : PersistBase<TbDocument>, IObjectHelper
	{
		#region Properties
        ...
        public static TbDocument RetrieveByKey(short documentID)
		{
			DBManager db = DBManager.GetInstance();
			return db.Engine.GetObject<TbDocument>(documentID);
		}
		...
		{			
			...
			string where = helper.GetExpression("TbDocument.DocumentID", documentID);
