...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class TbSalesmanUpload : PersistBase<TbSalesmanUpload>, IObjectHelper
	{
		#region Properties
		...
		public TbSalesmanUpload() : base()
		{
			// Default Constructor
		}
		///<summary>Initializes a new instance of this class</summary>
		///<param name="startTracking">Set to true to begin ORMapper tracking on this instance</param>
		public TbSalesmanUpload(bool startTracking) : base(startTracking)
		{
        ...
        public static TbSalesmanUpload RetrieveByKey(int documentID)
		{
			DBManager db = DBManager.GetInstance();
			return db.Engine.GetObject<TbSalesmanUpload>(documentID);
		}
		...
		{			
			...
			string where = helper.GetExpression("TbSalesmanUpload.DocumentID", documentID);
