...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class TbStockBalance : PersistBase<TbStockBalance>, IObjectHelper
	{
		#region Properties
		...
		///<summary>Database mapping to column tbStockBalance.ProductName</summary>
