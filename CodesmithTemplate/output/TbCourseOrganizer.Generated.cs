...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class TbCourseOrganizer : PersistBase<TbCourseOrganizer>, IObjectHelper
	{
		#region Properties
		...
		public TbCourseOrganizer() : base()
		{
			// Default Constructor
		}
		///<summary>Initializes a new instance of this class</summary>
		///<param name="startTracking">Set to true to begin ORMapper tracking on this instance</param>
		public TbCourseOrganizer(bool startTracking) : base(startTracking)
		{
        ...
        public static TbCourseOrganizer RetrieveByKey(short organizerID)
		{
			DBManager db = DBManager.GetInstance();
			return db.Engine.GetObject<TbCourseOrganizer>(organizerID);
		}
		...
		{			
			...
			string where = helper.GetExpression("TbCourseOrganizer.OrganizerID", organizerID);
