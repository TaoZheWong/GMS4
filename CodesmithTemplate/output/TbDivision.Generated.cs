...
{
	///<summary>Database mapping to table tbDivision</summary>
	[DataObject(true)]
    public partial class TbDivision : PersistBase<TbDivision>, IObjectHelper
	{
		#region Properties
	
		private short _divisionID;
		///<summary>Database mapping to column tbDivision.DivisionID</summary>
		...
		///<summary>Database mapping to column tbDivision.Name</summary>
		public string Name
		{
			get { return _name; }
			set
		...
		///<summary>Database mapping to column tbDivision.SeqID</summary>
		public short SeqID
		{
			get { return _seqID; }
			set
		...
		///<summary>Database mapping to column tbDivision.CreatedBy</summary>
		...
		///<summary>Database mapping to column tbDivision.CreatedDate</summary>
		...
		///<summary>Database mapping to column tbDivision.ModifiedBy</summary>
		...
		///<summary>Database mapping to column tbDivision.ModifiedDate</summary>
		...
		private IList<TbCompany> _tbCompanyList;
		///<summary>Collection of TbCompany objects</summary>
		public IList<TbCompany> TbCompanyList
		{
			get { return _tbCompanyList; }
		}
		
		#endregion
		
		///<summary>Initializes a new instance of this class</summary>
		public TbDivision() : base()
		{
			// Default Constructor
		}
		///<summary>Initializes a new instance of this class</summary>
		///<param name="startTracking">Set to true to begin ORMapper tracking on this instance</param>
		public TbDivision(bool startTracking) : base(startTracking)
		{
        ...
        public static TbDivision RetrieveByKey(short divisionID)
		{
			DBManager db = DBManager.GetInstance();
			return db.Engine.GetObject<TbDivision>(divisionID);
		}
		
		///<summary>Delete instance from the persistence store based on primary key(s)</summary>
		[DataObjectMethod(DataObjectMethodType.Delete)]
        public static int DeleteByKey(short divisionID)
		{			
			DBManager db = DBManager.GetInstance();		
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbDivision.DivisionID", divisionID);
		...
		public static int DeleteByKey(Wilson.ORMapper.Transaction transaction, short divisionID)
		{			
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("TbDivision.DivisionID", divisionID);
		...
		object IObjectHelper.this[string memberName]
		{
			get {
				switch (memberName) {
					...
					case "_tbCompanyList": return _tbCompanyList;
			...
			set {
				...
				switch (memberName) {
					...
					case "_tbCompanyList": _tbCompanyList = (IList<TbCompany>)value; break;
