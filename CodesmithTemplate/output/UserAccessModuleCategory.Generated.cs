...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class UserAccessModuleCategory : PersistBase<UserAccessModuleCategory>, IObjectHelper
	{
		#region Properties
		...
		public UserAccessModuleCategory() : base()
		{
			// Default Constructor
		}
        ...
        public static UserAccessModuleCategory RetrieveByKey(short userNumID, short moduleCategoryID)
		{
			DBManager db = DBManager.GetInstance();
			QueryHelper helper = db.Engine.QueryHelper;
			string where = helper.GetExpression("UserAccessModuleCategory.UserNumID", userNumID);
			where += " and ";
			where += helper.GetExpression("UserAccessModuleCategory.ModuleCategoryID", moduleCategoryID);
