...
namespace GMSCore.Entity
{
	...
	[DataObject(true)]
    public partial class tbFinanceAttachmentType : PersistBase<tbFinanceAttachmentType>, IObjectHelper
	{
		#region Properties
		...
		private string _financeAttachmentType;
		///<summary>Database mapping to column tbFinanceAttachmentType.FinanceAttachmentType</summary>
		public string FinanceAttachmentType
		{
			get { return _financeAttachmentType; }
			set
			{
				if (_financeAttachmentType != value)
				{
					_financeAttachmentType = value;
					OnPropertyChanged("FinanceAttachmentType");
				}
			}
		}
		...
		public tbFinanceAttachmentType() : base()
		{
			// Default Constructor
		}
		...
		object IObjectHelper.this[string memberName]
		{
			get {
				switch (memberName) {
					case "_id": return _id;
					case "_financeAttachmentType": return _financeAttachmentType;
			...
			set {
				...
				switch (memberName) {
					...
					case "_financeAttachmentType": _financeAttachmentType = (string)value; break;
		...
		public override string ToString()
		{
			...
			stb.AppendFormat("_financeAttachmentType={0}\n,", _financeAttachmentType.ToString() );
