...
{
	///<summary>Database mapping to table tbUserAccessModuleTemp</summary>
	[DataObject(true)]
    public partial class TbUserAccessModuleTemp : PersistBase<TbUserAccessModuleTemp>, IObjectHelper
	{
		#region Properties
	
		private short _userNumID = 0;
		///<summary>Database mapping to column tbUserAccessModuleTemp.UserNumID</summary>
		...
		private short _moduleID = 0;
		///<summary>Database mapping to column tbUserAccessModuleTemp.ModuleID</summary>
		...
		public TbUserAccessModuleTemp() : base()
		{
			// Default Constructor
		}
