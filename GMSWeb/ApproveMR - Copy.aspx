...
{ 
 ...
 window.onload = new function() { checkSouceInit();};
...
function checkAsset(a)
{
   ...
   if(MRNo != 'No Parameters Found')
   {
         if (document.getElementById('<%# chkAsset.ClientID %>').checked)
         {   
            document.getElementById('<%# chkAsset.ClientID %>').checked = false; 
         }
         else
         {
             document.getElementById('<%# chkAsset.ClientID %>').checked = true;  
         } 
...
<asp:UpdatePanel ID="upOutter" runat="server" UpdateMode="Conditional">
            ...
            <table class="tTable1" style="margin-left: 8px" cellspacing="5" cellpadding="5" border="0" width="108%">
                ...
                <td class="tbLabel">
                    ...
                    <td >
                        ...
                        <asp:DropDownList ID="ddlRequestor" runat="Server" CssClass="dropdownlist" />
                    </td>
                    ...
                    <asp:Image ID="imgCalendarMRDate" runat="server" ImageUrl="images/imgCalendar.gif" onclick="showCalendar2(this, 'imgCalendarMRDate', 'txtMRDate', 'dd/mm/yyyy', null, 1);" height="20" width="17" alt="" align="absMiddle" border="0" />                                
                    </td>
                ...
                <tr>                    
                    ...
                    <td style="width:5%" valign="top"> 
                        :</td>
                    <td >
                    <asp:TextBox runat="server" ID="txtRemarksByRequestor" TextMode="MultiLine" Width="200px"
                ...
                <tr>
                    ...
                    <td >
                        ...
                        <tr><td><asp:CheckBox ID="chkSample" runat="server" Text = "Sample" /></td><td><asp:CheckBox ID="chkWorkshop" runat="server" Text = "Workshop" /></td></tr>
                        </table>
                    </td> 
                    <td class="tbLabel">
                    ...
                    <td>
                        ...
                        <br /><br />
                        <asp:RadioButton ID="rbIsConsole" Name="rbIsConsole" runat="server" Text="Yes" ClientIDMode="Static" onclick="setConsoleDate('true')" />
                        <asp:RadioButton ID="rbIsNotConsole" Name="rbIsNotConsole" runat="server" Text="No" ClientIDMode="Static" Checked onclick="setConsoleDate('false')" />
                        ...
                        <asp:Image ID="imgCalendarConsoleDate" runat="server" ImageUrl="images/imgCalendar.gif" onclick="showCalendar2(this, 'imgCalendarConsoleDate', 'txtConsoleDate', 'dd/mm/yyyy', null, 1);" height="20" width="17" alt="" align="absMiddle" border="0" />
                ...
                <tr>
                 <td class="tbLabel" valign="top">
                    ...
                    <td style="width:5%" valign="top">
                        :</td>
                    <td >
                        <asp:TextBox runat="server" ID="txtOtherPurchaseReason" TextMode="MultiLine" Width="200px"
                            Height="50" onfocus="select();" EnableViewState="true" onchange="this.value = this.value.toUpperCase()" MaxLength="500"></asp:TextBox>
                    </td>
                    <td class="tbLabel" valign="top">
                        Cancelled Reason</td>
            ...
            <ajaxToolkit:TabContainer runat="server" ID="Tabs" ActiveTabIndex="0" Width="108%" CssClass="ajax__tab_xp" >
                                                ...
                                                <asp:TemplateColumn HeaderText="Product Code">
                                                    ...
                                                    <EditItemTemplate>
                                                        ...
                                                        <asp:LinkButton ID="lnkFindProduct" runat="server" CommandName="FindProduct" EnableViewState="true"
                                                            ...
                                                            <asp:TextBox ID="txtEditNewProdCode" runat="server" Columns="12" MaxLength="15" CssClass="textbox" onfocus="select();" onchange="this.value = this.value.toUpperCase()" Text='<%# Eval("NewProdCode")%>' />
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:TextBox ID="txtNewProductCode" runat="server" Columns="12" MaxLength="15" CssClass="textbox" onfocus="select();" onchange="this.value = this.value.toUpperCase()" OnTextChanged="txtNewProductCode_OnTextChanged" AutoPostBack="true" /><br />                                                                                                                           
                                                            ...
                                                            <br /><asp:Label ID="lblNewProductCode" runat="server" Text="New ProdCode : " Visible = "false"></asp:Label><br /><asp:TextBox ID="txtNewProdCode" runat="server" Visible="false" Columns="12" MaxLength="15" CssClass="textbox" onfocus="select();" onchange="this.value = this.value.toUpperCase()"></asp:TextBox><br /> 
            ...
            <li>PH - Product Head</li> 
                        ...
                        <ContentTemplate>
                            ...
                            <asp:DataGrid ID="dgDeliveryData" runat="server" AutoGenerateColumns="false" ShowFooter="true"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="GRN Date" HeaderStyle-Width="15%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblGRNDate" runat="server">
												        <%# Eval("GRNDate").ToString().Replace("\n", "<br />") %>												        
                                                        </asp:Label>                                                       
                                                    </ItemTemplate>
                                                    <EditItemTemplate>                                                                                                        
                                                        <%# Eval("GRNDate")%>                                                    
                                                ...
                                                <asp:TemplateColumn HeaderText="GRN No" HeaderStyle-Width="10%">
                                                    <ItemTemplate>
               ...
               <table style="text-align: left; width: 108%; margin-left:8px" cellspacing="5" cellpadding="5">    
               <tr>
                                <td>
               ...
               <asp:DataGrid ID="dgMRFormApproval" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="5"   
                ...
                <p></p>
                      ...
                      <table style="text-align: right; width: 108%" cellspacing="5" cellpadding="5">
                        <tr>
                            <td>                                                               
