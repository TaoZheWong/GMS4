<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorRecords1.aspx.cs" Inherits="GMSWeb.Procurement.Records.VendorRecords1" %>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtCompanyName" runat="server" Columns="100" MaxLength="100" CssClass="form-control" readonly/>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <div class="col-sm-8">
                                ...
                                <asp:TextBox ID="txtCompanyRegDate" runat="server" Columns="10" MaxLength="10"
                                    CssClass="form-control datepicker" readonly></asp:TextBox>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtContactPersonName" runat="server" Columns="100" MaxLength="100" CssClass="form-control" readonly />
                        </div>
                    </div>
