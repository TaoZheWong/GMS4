<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorRecords6.aspx.cs" Inherits="GMSWeb.Procurement.Records.VendorRecords6" %>
             ...
             <div class="panel panel-primary">     
                ...
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                         ...
                         <div class="form-group col-lg-12">       
                                <asp:TextBox TextMode="multiline" ID="txtTypesOfInsuranceSchemes" runat="server" Rows="5" Columns="100" MaxLength="100" CssClass="form-control" readonly/>    
                            ...
                            <EditItemTemplate>
                                <asp:TextBox CssClass="form-control input-sm" ID="txtEditCustomerName"
                                 ...
                                 <asp:RequiredFieldValidator
									ID="rfvEditCustomerName" runat="server" ControlToValidate="txtEditCustomerName" ErrorMessage="*" Display="dynamic" ValidationGroup="valGrpEditCustomerName" />
                            </EditItemTemplate>
                            <FooterTemplate>
                                <asp:TextBox CssClass="form-control input-sm" ID="txtNewCustomerName" runat="server" Columns="15" MaxLength="15" />
                                <asp:RequiredFieldValidator
									ID="rfvNewCustomerName" runat="server" ControlToValidate="txtNewCustomerName" ErrorMessage="*" Display="dynamic" ValidationGroup="valGrpNewCustomerName" />
                            </FooterTemplate>
                        </asp:TemplateColumn>
                         ...
                         <asp:TemplateColumn HeaderText="Project No">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox CssClass="form-control input-sm" ID="txtEditProjectNo" runat="server" Columns="15" MaxLength="50" Text='<%# Eval("ProjectNo") %>' />
                                  <asp:RequiredFieldValidator
									ID="rfvEditProjectNo" runat="server" ControlToValidate="txtEditProjectNo" ErrorMessage="*" Display="dynamic" ValidationGroup="valGrpEditProjectNo" />
                            </EditItemTemplate>
                            <FooterTemplate>
                                <asp:TextBox CssClass="form-control input-sm" ID="txtNewProjectNo" runat="server" Columns="15" MaxLength="50" />
                                 <asp:RequiredFieldValidator
									ID="rfvNewProjectNo" runat="server" ControlToValidate="txtNewProjectNo" ErrorMessage="*" Display="dynamic" ValidationGroup="valGrpNewProjectNo" />
                            </FooterTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="Year Of Completion">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox CssClass="form-control input-sm" ID="txtEditYearOfCompletion" runat="server" Columns="15" MaxLength="50" Text='<%# Eval("YearOfCompletion") %>' />
                                  <asp:RequiredFieldValidator
									ID="rfvEditYearOfCompletion" runat="server" ControlToValidate="txtEditYearOfCompletion" ErrorMessage="*" Display="dynamic" ValidationGroup="valGrpEditYearOfCompletion" />
                            </EditItemTemplate>
                            <FooterTemplate>
                                <asp:TextBox CssClass="form-control input-sm" ID="txtNewYearOfCompletion" runat="server" Columns="15" MaxLength="50" />
                                 <asp:RequiredFieldValidator
									ID="rfvNewYearOfCompletion" runat="server" ControlToValidate="txtNewYearOfCompletion" ErrorMessage="*" Display="dynamic" ValidationGroup="valGrpNewYearOfCompletion" />
                            </FooterTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center"
                            ...
                            <EditItemTemplate>
                                <asp:LinkButton ID="lnkSave" runat="server" CommandName="Update" EnableViewState="false"
                                    ValidationGroup="valGrpEditCustomerName" CssClass="btn btn-default btn-sm" data-toggle="tooltip" data-placement="top" title="Save"><i class="ti-check"></i></asp:LinkButton>
                            ...
                            <FooterTemplate>
                                <asp:LinkButton ID="lnkCreate" runat="server" CommandName="Create" EnableViewState="false"
                                    ValidationGroup="valGrpNewCustomerName" CssClass="btn btn-default btn-sm" data-toggle="tooltip" data-placement="top" title="Add"><i class="ti-plus"></i></asp:LinkButton>
                            </FooterTemplate>
                        </asp:TemplateColumn>
                    </Columns>
