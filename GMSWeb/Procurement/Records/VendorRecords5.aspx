<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorRecords5.aspx.cs" Inherits="GMSWeb.Procurement.Records.VendorRecords5" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtQANoOfPersonnel" runat="server" Columns="100" MaxLength="100" CssClass="form-control" readonly/>
            ...
            <div class="panel panel-primary">            
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                         <label class="col-sm-12 control-label text-left">  Is your company accredited with below certifications? (Please tick appropriately)</label>
