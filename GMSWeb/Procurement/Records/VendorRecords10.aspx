<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorRecords10.aspx.cs" Inherits="GMSWeb.Procurement.Records.VendorRecords10" %>
                            ...
                            <div class="col-sm-8">
                                ...
                                <asp:TextBox ID="txtDeclarationDate" runat="server" Columns="10" MaxLength="10"
                                 ...
                                 <asp:CompareValidator ID="cvDeclarationDate" runat="server" ErrorMessage="Invalid Date"
                                        ControlToValidate="txtDeclarationDate" Type="Date" Display="Dynamic" ValidationGroup="valGrpNewRow"
