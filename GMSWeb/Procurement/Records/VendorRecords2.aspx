<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorRecords2.aspx.cs" Inherits="GMSWeb.Procurement.Records.VendorRecords2" %>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                       ...
                       <div class="form-group col-lg-12">
                         <label class="col-sm-9 control-label text-left">
                             Agent/Distributor (Please attach a copy of the appointment letter from brand that you are representing)
                         </label>
