<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorEvaluationForm3.aspx.cs" Inherits="GMSWeb.Procurement.Forms.VendorEvaluationForm3" %>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-horizontal m-t-20">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtPaidUpCapital" runat="server" Columns="100" MaxLength="100" CssClass="form-control" />
                            <asp:CompareValidator
                             ID="cvPaidUpCapital" runat="server" ErrorMessage="*" Display="Dynamic" ControlToValidate="txtPaidUpCapital"
                             Type="Double" Operator="DataTypeCheck" ValidationGroup="valGrpVendorDetail" />
                          ...
                          <div class="form-group col-lg-12">
                            ...
                            <div class="col-sm-8">
                                ...
                                <asp:CompareValidator
                                ID="cvAnnualTurnover" runat="server" ErrorMessage="*" Display="Dynamic" ControlToValidate="txtAnnualTurnover"
                                Type="Double" Operator="DataTypeCheck" ValidationGroup="valGrpVendorDetail" />
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <div class="col-sm-8">
                                <asp:TextBox ID="txtAuthorizedCapital" runat="server" Columns="100" MaxLength="100"
                                    CssClass="form-control" />
                                 <asp:CompareValidator
                                ID="cvAuthorizedCapital" runat="server" ErrorMessage="*" Display="Dynamic" ControlToValidate="txtAuthorizedCapital"
                                Type="Double" Operator="DataTypeCheck" ValidationGroup="valGrpVendorDetail" />
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <div class="col-sm-8">
                                <asp:TextBox ID="txtCreditTerm" runat="server" Columns="100" MaxLength="100"
                                    CssClass="form-control" />
                                 <asp:CompareValidator
                                ID="cvCreditTerm" runat="server" ErrorMessage="*" Display="Dynamic" ControlToValidate="txtCreditTerm"
                                Type="Double" Operator="DataTypeCheck" ValidationGroup="valGrpVendorDetail" />
