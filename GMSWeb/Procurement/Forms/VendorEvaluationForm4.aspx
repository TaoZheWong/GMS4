<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorEvaluationForm4.aspx.cs" Inherits="GMSWeb.Procurement.Forms.VendorEvaluationForm4" %>
                            ...
                            <EditItemTemplate>
                                <asp:TextBox CssClass="form-control input-sm" ID="txtEditPersonnelName"
                                 ...
                                 <asp:RequiredFieldValidator
									ID="rfvEditPersonnelName" runat="server" ControlToValidate="txtEditPersonnelName" ErrorMessage="*" Display="dynamic" ValidationGroup="valGrpVendorPersonnel1" />
                            </EditItemTemplate>
                            <FooterTemplate>
                                <asp:TextBox CssClass="form-control input-sm" ID="txtNewPersonnelName" runat="server" Columns="15" MaxLength="15" />
                                <asp:RequiredFieldValidator
									ID="rfvNewPersonnelName" runat="server" ControlToValidate="txtNewPersonnelName" ErrorMessage="*" Display="dynamic" ValidationGroup="valGrpVendorPersonnel" />
                            </FooterTemplate>
                        </asp:TemplateColumn>
                         ...
                         <asp:TemplateColumn HeaderText="Designation">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox CssClass="form-control input-sm" ID="txtEditPersonnelDesignation" runat="server" Columns="15" MaxLength="50" Text='<%# Eval("PersonnelDesignation") %>' />
                                  <asp:RequiredFieldValidator
									ID="rfvEditPersonnelDesignation" runat="server" ControlToValidate="txtEditPersonnelDesignation" ErrorMessage="*" Display="dynamic" ValidationGroup="valGrpVendorPersonnel1" />
                            </EditItemTemplate>
                            <FooterTemplate>
                                <asp:TextBox CssClass="form-control input-sm" ID="txtNewPersonnelDesignation" runat="server" Columns="15" MaxLength="50" />
                                 <asp:RequiredFieldValidator
									ID="rfvNewPersonnelDesignation" runat="server" ControlToValidate="txtNewPersonnelDesignation" ErrorMessage="*" Display="dynamic" ValidationGroup="valGrpVendorPersonnel" />
                            </FooterTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center"
                            ...
                            <EditItemTemplate>
                                <asp:LinkButton ID="lnkSave" runat="server" CommandName="Update" EnableViewState="false"
                                     ValidationGroup="valGrpVendorPersonnel1" CssClass="btn btn-default btn-sm" data-toggle="tooltip" data-placement="top" title="Save"><i class="ti-check"></i></asp:LinkButton>
                            ...
                            <FooterTemplate>
                                <asp:LinkButton ID="lnkCreate" runat="server" CommandName="Create" EnableViewState="false"
                                     ValidationGroup="valGrpVendorPersonnel" CssClass="btn btn-default btn-sm" data-toggle="tooltip" data-placement="top" title="Add"><i class="ti-plus"></i></asp:LinkButton>
                            </FooterTemplate>
                        </asp:TemplateColumn>
                    </Columns>
            ...
            <div class="panel-footer clearfix">
                ...
                <div class="panel-footer clearfix">
                       <asp:Button ID="btnNext" Text="Next" EnableViewState="False" runat="server" CssClass="btn btn-primary pull-right m-r-10"
                        OnClick="btnNext_Click" ValidationGroup="valGrpVendorDetail"></asp:Button>
