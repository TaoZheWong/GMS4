...
{
    public partial class LatestPriceList : GMSBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.Params["isPriceList"] != null)
                    this.isPriceList = Request.Params["isPriceList"].ToString();
            if (!Page.IsPostBack)
            {
        ...
        protected void LoadDDLs()
        {
            ...
            {
                IList<DocumentCategory> lstCategory = new SystemDataActivity().RetrievePriceListDocumentCategory(4);
                if (lstCategory != null && lstCategory.Count > 0)
                {
                    this.ddlDocumentCategory.DataSource = lstCategory;
                    this.ddlDocumentCategory.DataBind();
            ...
            this.ddlBrand.DataSource = ds1.Tables[0];
        ...
        protected void PopulateDocument()
        {
            ...
            dalc.GetActivePriceList(short.Parse(this.ddlDocumentCategory.SelectedValue), ref ds);
        ...
        private void PopulateRepeater()
        {
            ...
            IList<DocumentCategory> lstCategory;

            if (this.isPriceList != "yes")
                lstCategory = new SystemDataActivity().RetrieveAllDocumentCategoryByModuleCategoryID(4);
            else
                lstCategory = new SystemDataActivity().RetrievePriceListDocumentCategory(4);
            ...
            if (lstCategory != null && lstCategory.Count > 0)
            {
                ...
                foreach (DocumentCategory rCategory in lstCategory)
                {
                    DocumentDataDALC dalc = new DocumentDataDALC();
                    DataSet ds = new DataSet();
                    dalc.GetActivePriceList(rCategory.DocumentCategoryID, ref ds);
