<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="ViewSalesOrder.aspx.cs" Inherits="GMSWeb.Sales.Sales.ViewSalesOrder" Title="Sales Order - Sales Order Details" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <h1 class="page-header">Sales Order Detail </h1>
                            ...
                            <ContentTemplate>
                                <asp:DataGrid ID="dgData" runat="server" AutoGenerateColumns="false" ShowFooter="false" OnItemDataBound="dgData_ItemDataBound"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="Delivered" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%# Eval("ClearFlag").ToString() == "Y"? "Yes":"No" %>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
