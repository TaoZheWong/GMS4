<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true"
    Codebehind="AddEditQuotation1.aspx.cs" Inherits="GMSWeb.Sales.Sales.AddEditQuotation1"
                                                ...
                                                <asp:TemplateColumn ItemStyle-Width="120px" HeaderStyle-HorizontalAlign="Center"
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:LinkButton ID="lnkCreate" runat="server" CommandName="Create" EnableViewState="true"
                                                            ValidationGroup="Product" CssClass="NewButt" OnClientClick="btnAddProductClick(this)"><span>Add</span></asp:LinkButton>
                                                    </FooterTemplate>
                                                </asp:TemplateColumn>
                                            </Columns>
                                                ...
                                                <asp:TemplateColumn ItemStyle-Width="120px" HeaderStyle-HorizontalAlign="Center"
                                                    ...
                                                    <EditItemTemplate>
                                                        <asp:LinkButton ID="lnkSave" runat="server" CommandName="Update" EnableViewState="false"
                                                            ValidationGroup="valGrpEditPackageRow" CssClass="SaveButt" OnClientClick="btnActionClick()"><span>Save</span></asp:LinkButton>
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:LinkButton ID="lnkCreate" runat="server" CommandName="Create" EnableViewState="false"
                                                            ValidationGroup="Package" CssClass="NewButt" OnClientClick="btnAddPackageClick(this)" ><span>Add</span></asp:LinkButton>
                                                    </FooterTemplate>
                                                </asp:TemplateColumn>
                                            </Columns>
    ...
    <table style="text-align: right; width: 100%" cellspacing="5" cellpadding="5">
        <tr>
            <td>
                ...
                <asp:Button runat="server" ID="btnSubmit" Text="Submit For Approval" CssClass="button" OnClick="btnSubmit_Click" />
                <asp:Button runat="server" ID="btnDeleteRevision" Text="Delete Revision" CssClass="button" OnClick="btnDeleteRevision_Click" Visible="false" />
        ...
        <tr>
            <td>
                ...
                <asp:LinkButton ID="lnkEmailPDF" OnClick="GenerateEmailPDFReport" runat="server" Text="Email PDF"
                    CssClass="button" ToolTip="Please click to email PDF report." CausesValidation="False" ><img id="img3" alt="" src="../../images/icons/mail.png" align="top" border="0" /></asp:LinkButton>  
            </td>
        </tr>
    </table> 
