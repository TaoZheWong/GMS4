<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="SalesOrderSearch.aspx.cs" Inherits="GMSWeb.Sales.Sales.SalesOrderSearch" Title="Sales Order - Search" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <h1 class="page-header">Sales Order <br />
        <small>Search customers' Sales Order in <b>real time</b>. This module directly linked to A21 system.</small></h1>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-3 col-md-6 col-sm-12">
                        <label class="control-label">Customer PO No</label>
                            <asp:TextBox runat="server" ID="txtPONumber" MaxLength="20" Columns="20" onfocus="select();"
                                CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="form-group col-lg-3 col-md-6 col-sm-12">
                        <label class="control-label">Ref No</label>
                            <asp:TextBox runat="server" ID="txtSONumber" MaxLength="20" Columns="20" onfocus="select();"
                                CssClass="form-control"></asp:TextBox>
                    </div>
                </div>
            </div>
    ...
    <div class="table-responsive">
        ...
        <Columns>
            ...
            <asp:TemplateColumn HeaderText="Ref No" SortExpression="TrnNo" HeaderStyle-Wrap="false">
                <ItemTemplate>
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ViewSalesOrder.aspx?TrnNo="+Eval("TrnNo")+"&DBVersion="+Eval("DBVersion")+"&StatusType="+Eval("StatusType")%>'><%# Eval("TrnNo")%></asp:HyperLink>
                </ItemTemplate>
            </asp:TemplateColumn>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".sub-sales-order").addClass("active");
        });
    </script>
</asp:Content>
