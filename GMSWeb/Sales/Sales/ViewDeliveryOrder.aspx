<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="ViewDeliveryOrder.aspx.cs" Inherits="GMSWeb.Sales.Sales.ViewDeliveryOrder" Title="Delivery Order - Delivery Order Details" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <ul class="breadcrumb pull-right">
        ...
        <li class="active">Delivery Order Detail</li>
    </ul>
    <h1 class="page-header">Delivery Order Detail </h1>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            ...
            <h4 class="panel-title">
                <i class="ti-info-alt"></i> Delivery Order Information
            </h4>
        </div>
            ...
            <div class="form-horizontal m-t-20">
                ...
                <div class="form-group col-lg-6 col-sm-6">
                    <label class="col-sm-6 control-label text-left">
                     ...
                     <label class="col-sm-6 control-label text-left">
                        <asp:Label runat="server" ID="lblCustPONo"></asp:Label>
                    </label>
                </div>
                <div class="form-group col-lg-6 col-sm-6">
                    <label class="col-sm-6 control-label text-left">
            ...
            <ajaxToolkit:TabPanel runat="server" ID="TabPanel1" HeaderText="Information">
                <ContentTemplate>
                    <asp:UpdatePanel ID="updatePanel1" runat="server">
                        <ContentTemplate>
                            <div class="container-fluid form-horizontal m-t-20">
                                <div class="row">
                                    <div class="form-group col-lg-6 col-sm-6">
                                        <label class="col-sm-6 control-label text-left">
                                            Delivery Address
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6 col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <asp:TextBox runat="server" ID="txtSONo" MaxLength="40" Columns="20" onfocus="select();"
                            ...
                            <asp:DataGrid ID="dgData" runat="server" AutoGenerateColumns="false" ShowFooter="false" OnItemDataBound="dgData_ItemDataBound" 
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="No">
                                        ...
                                        <input type="hidden" id="hidSrNo" runat="server" value='<%# Eval("SrNo")%>' /><input type="hidden" id="hidDoNo" runat="server" value='<%# Eval("DONo")%>' /><input type="hidden" id="hidDOType" runat="server" value='<%# Eval("DOType")%>' /></ItemTemplate>
                                    </asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn HeaderText="Amount">
                                        <ItemTemplate>
                                            <%# Eval("Currency")%> <asp:Label runat="server" ID="lblAmount"></asp:Label>
