    ...
    <div class="panel panel-primary" id="resultList" runat="server" visible="true">
        ...
        <div class="panel-body no-padding">
            <div class="table-responsive" style="overflow: auto">
                ...
                <telerik:RadButton runat="server" ID="RadButton1" Text="Submit" CssClass="pull-right btn m-l-5 bg-danger btn-lg" Skin="Bootstrap"
                ...
                <telerik:RadButton ID="btnUpdateSelected" runat="server" Text="Approve Selected Item" OnClick="btnUpdateSelected_Click" CssClass="pull-right bg-success" Width="175px"
                    SingleClick="true" SingleClickText="Updating" Visible="false"></telerik:RadButton>
                <telerik:RadGrid ID="RadGrid2" runat="server" Visible="false" OnPageIndexChanged="radGrid2_OnPageIndexChanged" OnPageSizeChanged="radGrid2_OnPageSizeChanged"
                    ...
                    <MasterTableView CommandItemDisplay="None"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn FilterControlAltText="Filter Weighted Cost column" HeaderText="Cost" HeaderStyle-Wrap="true" DataField="WeightedCost" ReadOnly="true" AllowFiltering="false">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridTemplateColumn UniqueName="TemplateCheckboxColumn" AllowFiltering="false" Visible="false">
                                <HeaderTemplate>
                                    <telerik:RadCheckBox ID="CheckAllCheckBox" runat="server" AutoPostBack="false" OnClientCheckedChanged="checkAllChanged" Text="Check current page"></telerik:RadCheckBox>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <telerik:RadCheckBox ID="RowCheckBox" runat="server" AutoPostBack="false"></telerik:RadCheckBox>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="server">
    <script type="text/javascript">
        ...
        function checkAllChanged(sender, args) {
            ...
            var checkboxes = $('.RadGrid .rgMasterTable .rgRow td .RadCheckBox').each(function (e) {
            ...
            //two row one is normal Row, another is Alternate Row
            var checkboxes = $('.RadGrid .rgMasterTable .rgAltRow td .RadCheckBox').each(function (e) {
                this.control.set_checked(sender.get_checked());
            })
        }
    </script>
