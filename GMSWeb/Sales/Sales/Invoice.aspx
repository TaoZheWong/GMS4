<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true"
    CodeBehind="Invoice.aspx.cs" Inherits="GMSWeb.Sales.Sales.Invoice" Title="Invoice - Search" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <h1 class="page-header">Invoice <br /><small>Search customers' Invoice in <b>real time</b>. This module directly linked to A21 system.</small></h1>
            ...
            <div class="m-t-20">
                ...
                <div class="row">
                    ...
                    <label class="control-label">Invoice No</label>
                        <asp:TextBox runat="server" ID="txtInvoiceNo" MaxLength="50" Columns="20" onfocus="select();"
                            CssClass="form-control" placeholder="e.g. DN00012"></asp:TextBox>
                </div>
                </div>
            </div>
        </div>
            ...
            <asp:DataGrid ID="dgData" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Ref No" SortExpression="TrnNo" HeaderStyle-Wrap="false">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ViewInvoice.aspx?TrnNo="+Eval("TrnNo")+"&TrnType="+Eval("TrnType")+"&DBVersion=" + Eval("DBVersion")+"&StatusType="+Eval("StatusType")%>'><%# Eval("TrnNo")%></asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateColumn>
