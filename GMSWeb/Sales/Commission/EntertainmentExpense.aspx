<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="EntertainmentExpense.aspx.cs" Inherits="GMSWeb.Sales.Commission.EntertainmentExpense" Title="Sales - Entertainment Expenses Page" %>
...
<h1>Commission &gt; Entertainment Expenses</h1>
            <p>List of entertainment expenses by salesman.</p>
            ...
            <br />
            <table style="margin-left: 8px;" width="910px">
                <tr>
                    <td>
                        <div>
                            ...
                            <asp:DataGrid ID="dgData" runat="server" AutoGenerateColumns="false" ShowFooter="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="Payee" HeaderStyle-Wrap="false">
                                        ...
                                        <EditItemTemplate>
                                            <span id="spanSalesPersonMasterName" runat="server" style='<%# ((bool)Eval("others"))?"visibility:hidden": "visibility:visible" %>'>
                                                <asp:DropDownList CssClass="dropdownlist" ID="ddlEditSalesPersonMasterName" runat="Server" DataTextField="SalesPersonMasterName"
                                                    DataValueField="SalesPersonMasterID" />
                                            </span>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <span id="spanSalesPersonMasterName" runat="server">
                                                <asp:DropDownList CssClass="dropdownlist" ID="ddlNewSalesPersonMasterName" runat="Server" DataTextField="SalesPersonMasterName"
                                    ...
                                    <asp:TemplateColumn HeaderText="Payment Date" ItemStyle-Width="90px">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox CssClass="textbox" runat="server" ID="editPaymentDate" MaxLength="10" Columns="10" Text='<%# Eval("Date", "{0: dd/MM/yyyy}") %>'></asp:TextBox>
                                            <img id="imgCalendarEditFrom" src="../../images/imgCalendar.gif" onclick="showCalendar(this, this.parentElement.all(0), 'dd/mm/yyyy', null, 1);"
                                        ...
                                        <FooterTemplate>
                                            <asp:TextBox CssClass="textbox" runat="server" ID="newPaymentDate" MaxLength="10" Columns="10"></asp:TextBox>
                                    ...
                                    <asp:TemplateColumn HeaderText="Area" HeaderStyle-Wrap="false" ItemStyle-Width="15px">
                                        ...
                                        <EditItemTemplate>
                                            <span id="spanArea" runat="server" style='<%# ((bool)Eval("others"))?"visibility:hidden": "visibility:visible" %>'>
                                                <asp:DropDownList CssClass="dropdownlist" ID="ddlEditArea" runat="server">
                                                    <asp:ListItem Value="1">Local</asp:ListItem>
                                                    <asp:ListItem Value="2">Export</asp:ListItem>
                                                </asp:DropDownList>
                                            </span>
                                        ...
                                        <FooterTemplate>
                                            <span id="spanArea" runat="server">
                                                <asp:DropDownList CssClass="dropdownlist" ID="ddlNewArea" runat="server">
                                                    <asp:ListItem Value="1">Local</asp:ListItem>
                                                    <asp:ListItem Value="2">Export</asp:ListItem>
                                                </asp:DropDownList>
                                            </span>
                                    ...
                                    <asp:TemplateColumn HeaderText="Amount" ItemStyle-Width="80px">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox CssClass="textbox" ID="txtEditAmount" runat="server" Columns="15" MaxLength="15" Text='<%# Eval("Amount", "{0:f2}") %>' />
                                        ...
                                        <FooterTemplate>
                                            <asp:TextBox CssClass="textbox" ID="txtNewAmount" runat="server" Columns="15" MaxLength="15" />
                                    ...
                                    <asp:TemplateColumn HeaderText="Remark" ItemStyle-Width="80px">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox CssClass="textbox" ID="txtEditRemark" runat="server" Columns="15" MaxLength="50" Text='<%# Eval("Remark") %>' />
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox CssClass="textbox" ID="txtNewRemark" runat="server" Columns="15" MaxLength="50" />
                                        </FooterTemplate>
                                    </asp:TemplateColumn>
