<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="GMSWeb.Sales.Reports.View" Title="Sales - Reports Page" %>
...
<a name="TemplateInfo"></a>
    ...
    <h1 class="page-header">Sales <br /> <small>Click a report to view.</small></h1>
                        ...
                        <asp:repeater id="rppReportList" runat="server" OnItemCommand="rppReportList_ItemCommand">
							<itemtemplate>
                                    <li class="list-group-item" runat="server">
                                        ...
                                        <asp:HiddenField ID="hidIsExternalReport" runat="server" Value='<%# Eval("IsExternalReport")%>' />
                                </li>
							</itemtemplate>
						</asp:repeater>
                    </ul>
