<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="GMSWeb.HR.Resources.View" %>
...
<body>
    ...
    <div id="ContentBar">
        ...
        <table class="tTable"style="BORDER-COLLAPSE: collapse" cellspacing="0" cellpadding="1" 
				border="1" width="80%">
        <tr>
        <td class="tbLabel">Resources Category</td><td style="width:5%">:</td>
        <td>
        <asp:DropDownList ID="ddlReportCategory" runat="Server" DataTextField="Name" DataValueField="ReportCategoryID" CssClass="dropdownlist" AutoPostBack="true" OnSelectedIndexChanged="ddlReportCategory_SelectedIndexChanged" /></td>
        </tr>
        </table>
        <asp:PlaceHolder ID="MainPanel" runat="server" Visible="false">
        <br /><br />
				    ...
				    <div class="tTable">
							    <asp:DataGrid ID="dgModify" runat="server" AutoGenerateColumns="false" ShowFooter="false"
								    ...
								    <Columns>
									    ...
									    <asp:TemplateColumn HeaderText="Resource Name" ItemStyle-Width="250px">
										    <ItemTemplate>
