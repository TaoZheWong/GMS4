<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="SystemGenerated.aspx.cs" Inherits="GMSWeb.SysHR.Reports.SystemGenerated" Title="HR & Training - Report Page" %>
...
<ul class="breadcrumb pull-right">
	...
	<li class="active">System Generated</li>
</ul>
<h1 class="page-header">
	View Report <small>Click a report to view.</small>
</h1>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".sub-view-reports").addClass("active");
        });
    </script>
</asp:Content>