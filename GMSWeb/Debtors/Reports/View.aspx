<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="GMSWeb.Debtors.Reports.View" Title="Debtors - Reports Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <h1 class="page-header">Debtors <br /><small>Click a report to view.</small></h1>
