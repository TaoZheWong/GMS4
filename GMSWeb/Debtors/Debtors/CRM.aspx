<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="CRM.aspx.cs" Inherits="GMSWeb.Debtors.Debtors.CRM" Title="Customer Info" ValidateRequest="false" %>
...
<h1>Customer Info &gt; <asp:Label ID="lblAccountCode" runat="server"></asp:Label>&nbsp;<asp:Label ID="lblAccountName" runat="server"></asp:Label></h1>
            ...
            <tr>
                ...
                <td><input class="crm_button" ID="btnLoadOutstandingPayment" value="Debts" runat="server" type="button" onserverclick="btnLoadOutstandingPayment_Click" ></td>
