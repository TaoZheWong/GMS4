                ...
                <ContentTemplate>
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            <p class="desc">
                                <asp:Label ID="lblParticularsMsg" runat="server"></asp:Label>
                            </p>
                            <div class="row">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">
                                        <asp:Label ID="lblContact" runat="server"></asp:Label></h4>
                                </div>
                        ...
                        <div class="panel-body no-padding ">
                            <p class="desc">
                                <span style="color: Red; size: 7px; font-style: italic;">
                                    <asp:Label ID="lblContactsMsg" runat="server"></asp:Label></span>
                            </p>
                    ...
                    <div class="modal fade" id="purchase-modal" style="display: none;">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">
                                        <asp:Label ID="lblPurchase" runat="server"></asp:Label></h4>
                                </div>
                                <div class="modal-body form-horizontal">
