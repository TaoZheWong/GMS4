<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="HRBudgetReport.aspx.cs" Inherits="GMSWeb.Budget.HRBudgetReport" %>
...
<ul class="breadcrumb pull-right">
    <li class="active">HR Budget Reports</li>
</ul>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            $(".hrbudget-menu").addClass("active expand");
            $(".sub-budget-report").addClass("active");
        });
    </script>
</asp:Content>
