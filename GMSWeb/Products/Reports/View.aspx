<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="GMSWeb.Products.Reports.View" Title="Products - Reports Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <h1 class="page-header">Product <br /><small>Click a report to view.</small></h1>
