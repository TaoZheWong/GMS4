<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="corporatebanner.aspx.cs" Inherits="GMSWeb.Corporate.corporatebanner" %>
...
<body>	
        <form id="form1" runat="server">
			...
			<hr style="margin-top: -8px; " color="#ff5c00" size="1px" />
