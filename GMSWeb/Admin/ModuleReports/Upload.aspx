...
<head id="Head1" runat="server">
    <title>Module Reports - Upload</title>
</head>
<body>
    <form id="form1" runat="server">
    <div id="ContentBar">
        <h3>Module Reports &gt; Upload</h3>
			    ...
			    <td>
				    ...
				    <div class="tblTable">
				        <table>
				            <tr>
				                <td>
					                <asp:Label ID="lblModuleCategory" runat="server">Module Category</asp:Label>
				                </td>
				                <td>
				                    <asp:DropDownList ID="ddlModuleCategory" runat="server" DataTextField="Name" DataValueField="ModuleCategoryID" />
				                </td>
				            </tr>
				            <tr>
				                <td>
