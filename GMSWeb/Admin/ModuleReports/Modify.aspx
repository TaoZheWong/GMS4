<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="GMSWeb.Reports.Setup.ModuleModify" %>
...
<head id="Head1" runat="server">
    <title>Module Reports - Modify</title>
</head>
<body>
    <form id="form1" runat="server">
    <div id="ContentBar">
        <h3>Module Reports &gt; Modify</h3>
