<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DivisionData.aspx.cs" Inherits="GMSWeb.Admin.SystemData.DivisionData" %>
...
<head id="Head1" runat="server">
    <title>System - Division</title>
</head>
<body>
    <form id="form1" runat="server">
    <div id="ContentBar">
        <h3>System &gt; Division</h3>
        Maintain a list of division for the group.
        <br />
        ...
        <table class="tTable" style="width: 100%">
            <tr>
			    <td>
				    <br />
				    <div class="tTable">
					    <atlas:UpdatePanel ID="udpDivisionUpdater" runat="server" Mode="conditional">
						    <ContentTemplate>
							    <asp:DataGrid ID="dgDivision" runat="server" AutoGenerateColumns="false" ShowFooter="true"
								    DataKeyField="DivisionId" OnCancelCommand="dgDivision_CancelCommand" OnEditCommand="dgDivision_EditCommand"
								    OnUpdateCommand="dgDivision_UpdateCommand" OnItemCommand="dgDivision_CreateCommand"
								    GridLines="none" OnItemDataBound="dgDivision_ItemDataBound" OnDeleteCommand="dgDivision_DeleteCommand"
								    ...
								    <Columns>
									    ...
									    <asp:TemplateColumn HeaderText="Division" ItemStyle-Width="80px">
										    <ItemTemplate>
