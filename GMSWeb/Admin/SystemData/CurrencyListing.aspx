<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CurrencyListing.aspx.cs" Inherits="GMSWeb.Admin.SystemData.CurrencyListing" %>
...
<body>
    ...
    <div id="ContentBar">
        ...
        Maintain a list of item currency.
        <br />
        ...
        <table class="tTable" style="width: 100%">
            <tr>
			    <td>
				    <br />
				    <div class="tTable">
					    <atlas:UpdatePanel ID="udpCurrencyUpdater" runat="server" Mode="conditional">
						    <ContentTemplate>
							    <asp:DataGrid ID="dgCurrency" runat="server" AutoGenerateColumns="false" ShowFooter="true"
								    DataKeyField="CurrencyCode" OnCancelCommand="dgCurrency_CancelCommand" OnEditCommand="dgCurrency_EditCommand"
								    OnUpdateCommand="dgCurrency_UpdateCommand" OnItemCommand="dgCurrency_CreateCommand"
								    GridLines="none" OnItemDataBound="dgCurrency_ItemDataBound" OnDeleteCommand="dgCurrency_DeleteCommand"
								    ...
								    <Columns>
									    ...
									    <asp:TemplateColumn HeaderText="Currency Code" ItemStyle-Width="35px">
										    <ItemTemplate>
											    <asp:Label ID="lblCode" runat="server">
												    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="Edit" EnableViewState="false"
												    CausesValidation="false"><span><%# Eval("CurrencyCode")%></span></asp:LinkButton>
											    </asp:Label>
										    </ItemTemplate>
										    <EditItemTemplate>
											    <asp:TextBox ID="txtEditCode" runat="server" Columns="20" MaxLength="50" Text='<%# Eval("CurrencyCode") %>' />
										        <asp:RequiredFieldValidator ID="rfvEditCode" runat="server" ControlToValidate="txtEditCode"
												    ErrorMessage="*" Display="dynamic" ValidationGroup="valGrpEditRow" /></EditItemTemplate>
										    <FooterTemplate>
											    <asp:TextBox ID="txtNewCode" runat="server" Columns="20" MaxLength="50" />
											    <asp:RequiredFieldValidator ID="rfvNewCode" runat="server" ControlToValidate="txtNewCode"
												    ErrorMessage="*" Display="dynamic" ValidationGroup="valGrpNewRow" />
										    </FooterTemplate>
									    </asp:TemplateColumn>
									    <asp:TemplateColumn HeaderText="Currency Sign" ItemStyle-Width="180px">
										    <ItemTemplate>
										    ...
										    <EditItemTemplate>
											    <asp:TextBox ID="txtEditSign" runat="server" Columns="20" MaxLength="50" Text='<%# Eval("CurrencySign") %>' />
										        <asp:RequiredFieldValidator ID="rfvEditSign" runat="server" ControlToValidate="txtEditSign"
												    ErrorMessage="*" Display="dynamic" ValidationGroup="valGrpEditRow" /></EditItemTemplate>
										    <FooterTemplate>
											    <asp:TextBox ID="txtNewSign" runat="server" Columns="20" MaxLength="50" />
											    <asp:RequiredFieldValidator ID="rfvNewSign" runat="server" ControlToValidate="txtNewSign"
												    ErrorMessage="*" Display="dynamic" ValidationGroup="valGrpNewRow" />
										    </FooterTemplate>
									    </asp:TemplateColumn>
									    <asp:TemplateColumn HeaderText="Currency Name" ItemStyle-Width="180px">
										    <ItemTemplate>
										    ...
										    <EditItemTemplate>
											    <asp:TextBox ID="txtEditName" runat="server" Columns="20" MaxLength="50" Text='<%# Eval("CurrencyName") %>' />
