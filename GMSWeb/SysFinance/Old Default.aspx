<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Old Default.aspx.cs" Inherits="GMSWeb.SysFinance.Default" %>
...
<link rel="shortcut icon" href="http://sgcitrix/gms/favicon.ico" type="image/x-icon" />
    ...
    <frameset border="0" frameborder="0" framespacing="-14" rows="94px,*" cols="100%" onload="fixSize()">
