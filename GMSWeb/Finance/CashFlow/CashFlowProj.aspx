<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="CashFlowProj.aspx.cs" Inherits="GMSWeb.Finance.CashFlow.CashFlowProj" Title="Finance - Cash Flow Projections Page" %>
<%@ MasterType VirtualPath="~/Common/Site.Master"%> 
<%@ Register TagPrefix="uctrl" TagName="MsgPanel" Src="~/CustomCtrl/MessagePanelControl.ascx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
<script type="text/javascript">
//<!--
	var GB_ROOT_DIR = "http://localhost/GMS/greybox/";
...
<script type="text/javascript" src="<%= Request.ApplicationPath %>/greybox/AJS.js"></script>
<script type="text/javascript" src="<%= Request.ApplicationPath %>/greybox/AJS_fx.js"></script>
<script type="text/javascript" src="<%= Request.ApplicationPath %>/greybox/gb_scripts.js"></script>
...
<h1>Finance &gt; Cash Flow Projections</h1>
<p>Enter weekly cash flow projections.</p>
<asp:ScriptManager ID="sriptmgr1" runat="server">
    <Services>
     ...
     <asp:LinkButton ID="LinkButton1" runat="server" Text="Launch full screen popup window" OnClientClick="return OpenFullScreenWindow();">Cash Flow Proj</asp:LinkButton>
...
<table class="tTable tBorder" style="margin-left: 8px" cellspacing="2" cellpadding="2" border="0" width="97%">
    ...
    <td align="right">
    <asp:Button runat="server" ID="btnSubmitData" CssClass="button" Text="Submit" OnClick="btnSubmitData_Click" ValidationGroup="Value" OnClientClick="btnActionClick()" />
