<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="FinanceReport.aspx.cs" Inherits="GMSWeb.Finance.Reports.FinanceReport" Title="Finance - Reports Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <h1 class="page-header">Financials <br /><small>Click a report to view.</small></h1>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".sub-financials").addClass("active");
        });
    </script>
</asp:Content>
