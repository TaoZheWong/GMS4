<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="FinanceProductReport.aspx.cs" Inherits="GMSWeb.Finance.Reports.FinanceProductReport" Title="Finance - Reports Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            $(".inventory-menu").addClass("active expand");
            $(".sub-product").addClass("active");
        });
    </script>
</asp:Content>
