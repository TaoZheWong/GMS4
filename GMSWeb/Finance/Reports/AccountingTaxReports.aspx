<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="AccountingTaxReports.aspx.cs" Inherits="GMSWeb.Finance.Reports.AccountingTaxReports" Title="Finance - Reports Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".sub-accounting-report").addClass("active");
        });
    </script>
</asp:Content>
