<%@ Page Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="FinanceGroupReport.aspx.cs" Inherits="GMSWeb.Finance.Reports.FinanceGroupReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            $(".group-menu").addClass("active expand");
