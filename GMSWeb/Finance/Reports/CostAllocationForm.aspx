<%@ Page Language="C#"  MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="CostAllocationForm.aspx.cs" Inherits="GMSWeb.Finance.Reports.CostAllocationForm" Title="Finance - Cost Allocation Form" %>
...
<ul class="breadcrumb pull-right">
    <li class="active">Cost Allocation Form</li>
</ul>
<h1 class="page-header">Forms <small>Click a form to view.</small></h1>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".sub-form-costallocation").addClass("active");
        });
    </script>
</asp:Content>