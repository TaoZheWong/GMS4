<%@ Page Language="C#"  MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="FinanceMonthlyReports.aspx.cs" Inherits="GMSWeb.Finance.Reports.FinanceMonthlyReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".sub-MonthlyReport-report").addClass("active");
        });
    </script>
</asp:Content>