<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MovementList.aspx.cs" Inherits="GMSWeb.HR.UploadedReports.MovementList" %>
...
<head id="Head1" runat="server">
    <title>Reports - Movement List</title>
</head>
<body>
    <form id="form1" runat="server">
    <div id="ContentBar">
        <h3>Reports &gt; Movement List</h3>
        
        List of HR movement list reports.
        <br /><br />
						    ...
						    <ContentTemplate>
							    <asp:DataGrid ID="dgModify" runat="server" AutoGenerateColumns="false" ShowFooter="false"
								    ...
								    <Columns>
									    ...
									    <asp:TemplateColumn HeaderText="Movement List Reports" ItemStyle-Width="250px">
										    <ItemTemplate>
