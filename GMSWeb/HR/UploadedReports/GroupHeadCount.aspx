<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupHeadCount.aspx.cs" Inherits="GMSWeb.HR.UploadedReports.GroupHeadCount" %>
...
<head id="Head1" runat="server">
    <title>Reports - Group Head Count</title>
</head>
<body>
    <form id="form1" runat="server">
    <div id="ContentBar">
        <h3>Reports &gt; Group Head Count</h3>
        
        List of HR group head count reports.
        <br /><br />
						    ...
						    <ContentTemplate>
							    <asp:DataGrid ID="dgModify" runat="server" AutoGenerateColumns="false" ShowFooter="false"
								    ...
								    <Columns>
									    ...
									    <asp:TemplateColumn HeaderText="Group Head Count Reports" ItemStyle-Width="250px">
										    <ItemTemplate>
