<%@ Page Language="C#" AutoEventWireup="true" Codebehind="CommissionNGPQ.aspx.cs"
    Inherits="GMSWeb.Sales.Commission.CommissionNGPQ" %>

<%@ Register TagPrefix="uctrl" TagName="MsgPanel" Src="~/CustomCtrl/MessagePanelControl.ascx" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Commission - Commission Rate & GPQ</title>

    <script language="javascript" type="text/javascript" src="/GMS/scripts/popcalendar.js"></script>
    <script language="javascript" type="text/javascript">
    var mode = "add";
    function FillData(selObj) 
    {
        if (mode == "add")
        {
            var str = "";
            ...
            document.getElementById(document.getElementById('txtBoxID').value).value = str;
            document.getElementById(document.getElementById('txtHiddenID').value).value = str;
            return;
        }
        if (mode == "edit")
        {
            ...
            document.getElementById(document.getElementById('txtEditBoxID').value).value = str;
            document.getElementById(document.getElementById('txtEditHiddenID').value).value = str;
            return;
        }
    }
    ...
    {
        var selObj = document.getElementById('lsbAccounts');
        for (var i = 0; i < selObj.options.length; i++) 
        {
            if (selObj.options[i].selected) 
            {
        ...
        <div id="GroupContentBar">
            ...
            <asp:Panel ID="PNL" runat="server" Style="display: none; width: 500px; background-color: White;
                ...
                <div style="text-align: center;">
                    ...
                    <asp:Button ID="ButtonOk" runat="server" Text="Save" OnClientClick="FillData(document.getElementById('lsbAccounts'))" />
