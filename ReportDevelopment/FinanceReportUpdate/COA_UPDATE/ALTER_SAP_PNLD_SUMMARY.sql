ALTER PROCEDURE [dbo].[procFinanceTBProcess_COA2016_SAP_InsertPNLDetailSummary]
AS 
--****************************************
--COA 2016
--****************************************
...
'(PNLD)Amortisation-Club Membership',
'(PNLD)Written Off-Trade Name',
'(PNLD)Written Off-Cust Relationship')
GROUP BY f.CoyID, f.ProjectID, f.DepartmentID, f.SectionID, f.UnitID, f.tbYear, f.tbMonth, i2.ItemID
